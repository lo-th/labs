...
case "oimo":c="js/worker/oimo_worker.js";h="../../js/libs/oimo.min.js";d=1E3;f=e=10;g=0;l=8;k=3;this.update=this.upOimo;this.postMess=this.postOimo;break;case "ammo":this.testNewAmmo?(c="js/worker/ammo_worker_new.js",h="../../js/libs/ammo.js"):(c="js/worker/ammo_worker.js",h="../../js/libs/ammo.min.js");d=1E3;e=20;f=10;g=0;l=8;k=40;this.update=this.upAmmo;this.postMess=this.postAmmo;break;case "traffic":c="js/worker/traffic_worker.js",h="../../js/libs/traffic.min.js",d=1E3,f=e=10,g=0,k=l=3,this.update=
...
0,0,64,64);this.environment=new THREE.Texture(a);this.environment.needsUpdate=!0;for(var b=this.shaders.length;b--;)this.shaders[b].isActive&&(this.shaders[b].uniforms.env.value=this.environment)}.bind(this);a.src="images/spherical/"+this.envLists[this.nEnv]},add:function(a){this.shaders.push(a)}};V.BvhPlayer=function(a){this.root=a;this.reader=new V.BvhReader(this.root);this.model=null;this.qdecalLeft=(new THREE.Quaternion).setFromAxisAngle(new THREE.Vector3(0,0,1),21*V.ToRad);this.qdecalRight=(new THREE.Quaternion).setFromAxisAngle(new THREE.Vector3(0,0,1),-21*V.ToRad);this.qdecalLeft2=(new THREE.Quaternion).setFromAxisAngle(new THREE.Vector3(0,0,1),-90*V.ToRad);this.qdecalRight2=(new THREE.Quaternion).setFromAxisAngle(new THREE.Vector3(0,0,1),90*V.ToRad)};
...
updateSkin:function(){for(var a=this.reader.type,b,c,d,e=this.reader.Nodes,f=this.bones.length,g,l,k,h=new THREE.Quaternion,n=new THREE.Vector3,p=new THREE.Vector3,m=0;m<f;m++)b=this.bones[m],d=b.name,k=b.parent.matrixWorld||new THREE.Matrix4,l=b.parent.mtx?b.parent.mtx:k,(c=e[d])?(g=c.matrixWorld.clone(),n.setFromMatrixPosition(g),h.setFromRotationMatrix(g),"cgspeed3DS"===a&&("RightUpLeg"!==d&&"RightLowLeg"!==d&&"RightFoot"!==d||h.multiply(this.qdecalRight),"LeftUpLeg"!==d&&"LeftLowLeg"!==d&&"LeftFoot"!==
d||h.multiply(this.qdecalLeft),"RightUpArm"!==d&&"RightLowArm"!==d&&"RightHand"!==d||h.multiply(this.qdecalRight2),"LeftUpArm"!==d&&"LeftLowArm"!==d&&"LeftHand"!==d||h.multiply(this.qdecalLeft2)),c=new THREE.Matrix4,b.rootMatrix||(b.rootMatrix=b.matrixWorld.clone()),c.makeRotationFromQuaternion(h),c.multiply(b.rootMatrix),c.setPosition(n),g=(new THREE.Matrix4).getInverse(k),g=(new THREE.Matrix4).multiplyMatrices(g,c),c.multiplyMatrices(k,g),this.preservesBoneSize&&"Hips"!==d&&(g=(new THREE.Matrix4).getInverse(l),
p.setFromMatrixPosition(b.matrix),g=(new THREE.Matrix4).multiplyMatrices(g,c),g.setPosition(p),c=(new THREE.Matrix4).multiplyMatrices(l,g))):c=(new THREE.Matrix4).multiplyMatrices(l,b.matrix),b.mtx=c}};
...
V.BvhReader=function(a){this.root=a;this.debug=!0;this.type="deff";this.searchType=!0;this.rootBone=this.data=null;this.secsPerFrame=this.numFrames=0;this.play=!1;this.channels=null;this.lines="";this.speed=0.5;this.nodes=null;this.order={};this.Nodes=this.BoneByName=this.ChildNodes=this.ParentNodes=null;this.startTime=this.oldFrame=this.frame=0;this.position=new THREE.Vector3(0,0,0);this.scale=1;this.tmpOrder="";this.tmpAngle=[];this.skeleton=null;this.bones=[];this.nodesMesh=[];this.nodeSize=this.boneSize=
0.4;this.endFunction=null;this.boxgeo=(new THREE.BufferGeometry).fromGeometry(new THREE.BoxGeometry(1.5,1.5,1));this.boxgeo.applyMatrix((new THREE.Matrix4).makeTranslation(0,0,0.5));this.nodegeo=(new THREE.BufferGeometry).fromGeometry(new THREE.SphereGeometry(this.nodeSize,8,6));this.boneMaterial=new THREE.MeshBasicMaterial({color:16777028});this.nodeMaterial=new THREE.MeshBasicMaterial({color:8978312})};
V.BvhReader.prototype={constructor:V.BvhReader,load:function(a,b){this.callback=b||function(){};var c=a.substring(a.length-3,a.length);if("bvh"===c){var d=new XMLHttpRequest;d.open("GET",a,!0);d.onreadystatechange=function(){4==d.readyState&&this.parseData(d.responseText.split(/\s+/g))}.bind(this);d.send(null)}else"png"===c&&window.top.main.transcode.load(a,function(a){this.parseData(a.split(/\s+/g))}.bind(this))},parseData:function(a){this.data=a;this.channels=[];this.nodes=[];this.Nodes={};this.distances=
{};this.ParentNodes={};this.ChildNodes={};this.BoneByName={};for(a=!1;!a;)switch(this.data.shift()){case "ROOT":null!==this.rootBone&&this.clearNode();null!==this.skeleton&&this.clearSkeleton();this.rootBone=this.parseNode(this.data);this.rootBone.position.copy(this.position);this.rootBone.scale.set(this.scale,this.scale,this.scale);break;case "MOTION":this.data.shift(),this.numFrames=parseInt(this.data.shift()),this.data.shift(),this.data.shift(),this.secsPerFrame=parseFloat(this.data.shift()),a=
...
this.boneSize,this.distances[d])))},testBvhType:function(a){"ToSpine"===a&&(this.type="openMotion",this.searchType=!1);"rButtock"===a&&(this.type="cgspeedDAZ",this.searchType=!1);"RHipJoint"===a&&(this.type="cgspeed3DS",this.searchType=!1)},transposeName:function(a){if("hip"===a||"SpineBase"===a)a="Hips";if("abdomen"===a||"SpineBase2"===a)a="Spine1";if("chest"===a||"SpineMid"===a)a="Chest";if("neck"===a||"Neck2"===a)a="Neck";"head"===a&&(a="Head");if("rCollar"===a||"rcollar"===a||"CollarRight"===
a)a="RightCollar";if("lCollar"===a||"lcollar"===a||"CollarLeft"===a)a="LeftCollar";"upperback"===a&&(a="Spine1");"Chest2"===a&&(a="Chest");"cgspeed3DS"==this.type&&("lowerback"===a&&(a="Spine1"),"Spine1"===a&&(a="Chest"));if("rThigh"===a||"RightHip"===a||"HipRight"===a)a="RightUpLeg";if("lThigh"===a||"LeftHip"===a||"HipLeft"===a)a="LeftUpLeg";if("rShin"===a||"RightKnee"===a||"KneeRight"===a)a="RightLowLeg";if("lShin"===a||"LeftKnee"===a||"KneeLeft"===a)a="LeftLowLeg";if("rFoot"===a||"RightAnkle"===
a||"AnkleRight"===a)a="RightFoot";if("lFoot"===a||"LeftAnkle"===a||"AnkleLeft"===a)a="LeftFoot";"RightLeg"===a&&(a="RightLowLeg");"LeftLeg"===a&&(a="LeftLowLeg");if("rtoes"===a||"RightToeBase"===a)a="RightToe";if("ltoes"===a||"LeftToeBase"===a)a="LeftToe";if("rShldr"===a||"RightArm"===a||"RightShoulder"===a||"ShoulderRight"===a)a="RightUpArm";if("lShldr"===a||"LeftArm"===a||"LeftShoulder"===a||"ShoulderLeft"===a)a="LeftUpArm";if("rForeArm"===a||"RightForeArm"===a||"RightElbow"===a||"ElbowRight"===
a)a="RightLowArm";if("lForeArm"===a||"LeftForeArm"===a||"LeftElbow"===a||"ElBowLeft"===a)a="LeftLowArm";if("rHand"===a||"RightWrist"===a||"WristRight"===a)a="RightHand";if("lHand"===a||"LeftWrist"===a||"WristLeft"===a)a="LeftHand";return a},parseNode:function(a){var b,c,d;b=a.shift();this.searchType&&this.testBvhType(b);b=this.transposeName(b);d=new THREE.Group;d.name=b;for(b=!1;!b;)switch(a.shift()){case "OFFSET":d.position.set(parseFloat(a.shift()),parseFloat(a.shift()),parseFloat(a.shift()));d.offset=
d.position.clone();break;case "CHANNELS":c=parseInt(a.shift());for(var e=0;0<=c?e<c:e>c;0<=c?e++:e--)this.channels.push({node:d,prop:a.shift()});break;case "JOINT":case "End":d.add(this.parseNode(a));break;case "}":b=!0}this.nodes.push(d);return d},clearNode:function(){var a;if(this.nodes){for(a=0;a<this.nodes.length;a++)this.nodes[a]=null;this.nodes.length=0}},animate:function(){for(var a,b=this.frame%this.numFrames*this.channels.length,c=this.channels,d=!1,e=!1,f=0,g=c.length;f<g;f++){a=c[f];d=
"Hips"===a.node.name?!0:!1;e="cgspeedDAZ"===this.type&&"LeftLowArm"===a.node.name?!0:!1;switch(a.prop){case "Xrotation":this.autoDetectRotation(a.node,"X",parseFloat(this.data[b]));break;case "Yrotation":e?this.autoDetectRotation(a.node,"Y",-parseFloat(this.data[b])):this.autoDetectRotation(a.node,"Y",parseFloat(this.data[b]));break;case "Zrotation":e?this.autoDetectRotation(a.node,"Z",-parseFloat(this.data[b])):this.autoDetectRotation(a.node,"Z",parseFloat(this.data[b]));break;case "Xposition":a.node.position.x=
