...
c.className="ic";var d=document.createElement("div");d.style.cssText="position:relative; left:10px; top:5px; width:18px; height:18px; pointer-events:none; background-color: none; border:2px solid rgba(0,0,0,0);  border-radius:20px; pointer-events:none;";var f=document.createElement("div");f.style.cssText="position:relative; left:5px; top:-12px; width:148px; height:20px; pointer-events:none; text-align:right; pointer-events:none;";var e=document.createElement("div");e.style.cssText="position:relative; left:15px; top:-28px; width:8px; height:8px; pointer-events:none; background-color: "+
