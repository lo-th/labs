...
TERRAIN.Generate.prototype = {
    ...
    init:function () {
        ...
        var geo = new THREE.PlaneBufferGeometry(this.size[0], this.size[2], this.div[0], this.div[1]);
        //THREE.BufferGeometryUtils.fromGeometry( geometry );
        //geometry.dispose();

        this.mesh = new THREE.Mesh( geo, new THREE.MeshBasicMaterial( { color:0xFF5555, wireframe:true } ) );
    ...
    start:function() {
        ...
        this.uniformsTerrain = THREE.UniformsUtils.merge( [
            THREE.UniformsLib[ 'fog' ],
            THREE.UniformsLib[ 'lights' ],
            THREE.UniformsLib[ 'shadowmap' ], terrainShader.uniforms]);
       ...
       // this.uniformsTerrain[ 'envMap' ].value = this.envMap;
        ...
        this.uniformsTerrain[ 'env' ].value = THREE.ImageUtils.loadTexture( './images/spherical/e_chrome.jpg');
      ...
      /*  var params = [
        ...
        var params = [
                        [ 'heightmap',  terrainNoise.fs, terrainNoise.vs, this.uniformsNoise, false ],
                        [ 'normal',     normalShader.fs,  normalShader.vs, this.uniformsNormal, false ],
                        [ 'terrain',    terrainShader.fs, terrainShader.vs, this.uniformsTerrain, true ]
                     ];
        ...
        this.mesh.material = this.mlib.terrain;//this.mlib[ 'terrain' ];
    ...
    applyShader:function () {
        ...
        var meshTmp = new THREE.Mesh( new THREE.PlaneBufferGeometry( this.W, this.H ), shaderMaterial );
        meshTmp.position.z = -500;

        sceneTmp.add( meshTmp );

        this.main.renderer.render( sceneTmp, this.cameraOrtho, this.specularMap, true );
