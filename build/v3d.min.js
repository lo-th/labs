...
tell:function(a){this.info.innerHTML=a},addBlob:function(a,b,c){a=new V.Blob(this,a,b);if(c)return a;this.meshs[this.meshs.length]=a},addSolid:function(a){var b=new THREE.Mesh(this.geo[a.type||"box"],this.mat.solid);a.pos=a.pos||[0,0,0];a.size=a.size||[1,1,1];b.scale.set(a.size[0],a.size[1],a.size[2]);b.position.set(a.pos[0],a.pos[1],a.pos[2]);b.rotation.set(0,0,0);this.scene.add(b);a=new THREE.BoxHelper(b);a.material=this.mat.chaine;this.scene.add(a)},add:function(a){var b=new THREE.Mesh(this.geo[a.type||
"box"],this.mat[a.mat||"base2"]);a.pos=a.pos||[0,0,0];a.size=a.size||[1,1,1];b.scale.set(a.size[0],a.size[1],a.size[2]);b.position.set(a.pos[0],a.pos[1],a.pos[2]);b.rotation.set(0,0,0);this.scene.add(b);this.meshs[this.meshs.length]=b;this.w&&this.w.add(a)},addParticle:function(a){var b=this.ps.length;this.ps[b]=new V.Particle(this,a);a.id=b;this.w&&this.w.addParticle(a)},initGeo:function(){var a={};a.sphere=(new THREE.BufferGeometry).fromGeometry(new THREE.SphereGeometry(1,12,10));a.sphereHigh=(new THREE.BufferGeometry).fromGeometry(new THREE.SphereGeometry(1,
...
transparent:!0,opacity:0.1,fog:!1,depthTest:!1,depthWrite:!1});a.base=new THREE.MeshBasicMaterial({color:0});a.anchor=new THREE.MeshBasicMaterial({color:16711795});a.chaine=new THREE.LineBasicMaterial({color:16711795,transparent:!0,opacity:0.3});a.Sanchor=new THREE.MeshBasicMaterial({color:16777215});a.base2=new THREE.MeshBasicMaterial({color:65280,map:THREE.ImageUtils.loadTexture("images/grid1.jpg")});a.solid=new THREE.MeshBasicMaterial({color:16711795,transparent:!0,opacity:0.1,depthWrite:!1});
...
3]),a[b].quaternion.set(this.ar[c+4],this.ar[c+5],this.ar[c+6],this.ar[c+7]));this.computeTime()},postOimo:function(){this.w.postMessage({m:"run",m2:this.msg,drn:this.drn,drc:this.drc,ar:this.ar,dr:this.dr},[this.ar.buffer])},room:function(a){var b=0.5*a.h-a.m,c=[a.w-a.m,a.m,a.d-a.m,a.w+a.m,a.h,a.m,a.w+a.m,a.h,a.m,a.m,a.h,a.d-a.m,a.m,a.h,a.d-a.m];a=[0,0.5*-a.m,0,0,b,0.5*-a.d,0,b,0.5*a.d,0.5*-a.w,b,0,0.5*a.w,b,0];this.w.postMessage({m:"room",obj:{n:5,size:c,pos:a}});for(var b=5,d;b--;)d=3*b,v.addSolid({type:"box",
size:[c[d],c[d+1],c[d+2]],pos:[a[d],a[d+1],a[d+2]]})},add:function(a){this.w.postMessage({m:"add",obj:a})},addParticle:function(a){this.w.postMessage({m:"addParticle",obj:a})},post:function(a){this.w.postMessage(a)},chaine:function(a){a.close&&(this.drc[0]=1);var b=0.5*a.points.length;this.drn[0]=b;for(var c,d=0;d<b;d++)c=2*d,this.dr[c]=a.points[c],this.dr[c+1]=a.points[c+1];this.msg="updecal"}};
