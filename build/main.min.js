...
c.substr(c.lastIndexOf(".")+1,c.length);b.pushFile(c)};c.readAsDataURL(a)},pushFile:function(a){for(var b=this.files.length;b--;)if(a==this.files[b])return;var b=this.icons.length,c=document.createElement("div");c.className="ic";var d=document.createElement("div");d.style.cssText="position:relative; left:10px; top:5px; width:18px; height:18px; pointer-events:none; background-color: none; border:2px solid rgba(0,0,0,0);  border-radius:20px; pointer-events:none;";var e=document.createElement("div");
e.style.cssText="position:relative; left:5px; top:-12px; width:148px; height:20px; pointer-events:none; text-align:right; pointer-events:none;";var f=document.createElement("div");f.style.cssText="position:relative; left:15px; top:-28px; width:8px; height:8px; pointer-events:none; background-color: "+this.colorSelect+";  border-radius:20px;";e.innerHTML=a.substr(0,a.lastIndexOf("."));c.appendChild(d);c.appendChild(e);c.appendChild(f);this.zone.appendChild(c);c.name=b;c.onclick=function(a){this.openFile(a)}.bind(this);
...
"2px solid "+this.colorOver)},unselected:function(a){a.target.className="ic icout";a.preventDefault();a=a.target.name;a!==this.currentFile&&(this.icons[a].childNodes[0].style.border="2px solid rgba(0,0,0,0)")},addIconLink:function(a,b,c){window.URL=window.webkitURL||window.URL;this.currentLink&&(window.URL.revokeObjectURL(this.currentLink.href),this.currentLink=null);this.currentLink=document.createElement("a");this.currentLink.style.cssText="position:absolute; top:6px; right:65px; width:120px; height:20px; text-align:center;";
