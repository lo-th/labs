...
(this.preview=this.doc.createElement("iframe"),this.preview.className="preview",this.doc.body.appendChild(this.preview));this.resize();this.previewDoc=this.preview.contentDocument||this.preview.contentWindow.document;var a="<script src='./src/Vue3d.js'>\x3c/script>",b="<script src='./js/libs/three.js'>\x3c/script>";isMain&&(a="<script src='./build/v3d.min.js'>\x3c/script>",b="<script src='./js/libs/three.min.js'>\x3c/script>");for(var c="",d=LTH.option[LTH.cRubrique][LTH.cFile],e=d.length;e--;)c+=
"<script src='./js/libs/"+d[e]+".min.js'>\x3c/script>";a=["<!DOCTYPE html>\n<html lang='en'>\n<head>\n<title>prev</title>\n<meta charset='utf-8'>\n<link rel='stylesheet' href='./css/consolas.css'>\n<link rel='stylesheet' href='./css/basic.css'>",b,"<script src='./js/libs/three.post.js'>\x3c/script>",c,a,"<script id='shader'>\x3c/script>\n</head><body>\n<script> var main = null; var canvas = document.createElement('canvas'); document.body.appendChild( canvas );\x3c/script>\n</body></html>"].join("\n");
this.preview.src="about:blank";this.previewDoc=this.preview.contentDocument||this.preview.contentWindow.document;this.previewDoc.open("text/html","replace");this.previewDoc.write(a);this.previewDoc.close()},update:function(a,b){if(b&&""!==a){null!==this.preview&&this.clearPreview();this.initPreview();var c=this;this.preview.onload=function(b){c.previewTheme();c.previewMain=c.preview.contentWindow;"shader"===c.mode&&(c.previewMain.main=c);b=c.previewDoc.getElementsByTagName("head")[0];c.preview.style.display=
"block";var e=c.previewDoc.createElement("script");e.setAttribute("id","base");e.type="text/javascript";e.charset="utf-8";e.text=a;b.appendChild(e);c.codeLoaded=!0;c.previewTheme();c.isFirst?c.isFirst=!1:c.showModif()}}},checkCurrent:function(){for(var a=0;a<this.numLesson;a++)this.items[a].style.background=this.items[a].name==this.currentLesson?"#881288":"#121212"},loadFile:function(a){this.isFirst=!0;this.fileSystem.load(a)},openFile:function(a){this.fileSystem.open(a)},createLink:function(a,b,
c){this.menu.addIconLink(a,b,c)},showModif:function(){this.menu.modified()},callSave:function(){this.fileSystem.save()}};LTH.ShaderToy=function(a){this.main=a;this.retour=document.createElement("div");this.retour.innerHTML=".join('&#92;n')";this.shaderName="";this.shaderBase=null;this.uniformValues={};this.uniformColors={};this.isShaderReady=!1};
...
b;c.appendChild(d);try{this.shaderBase=this.main.previewMain.V[a],this.shaderName=a}catch(e){}finally{this.getUniformValue(this.shaderBase.uniforms),this.main.editorVertex.set(this.shaderBase.vs,!0),this.main.editorFragment.set(this.shaderBase.fs,!0),this.main.preview.contentWindow.shader.apply(this.shaderBase),this.isShaderReady=!0}}},getUniformValue:function(a){this.uniformValues={};for(var b in a){var c=a[b].type,d=JSON.stringify(a[b].value);console.log(b,d,c);"c"===c?this.uniformColors[b]=d:this.uniformValues[b]=
