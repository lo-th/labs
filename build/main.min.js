...
this.content.appendChild(this.pinsContent);this.ctx=this.canvas.getContext("2d");this.canvas.width=this.canvas.height=this.size;this.isComputed||this.compute();this.radius=this.time=10;this.line=1;this.update()},reset:function(){},update:function(){this.radius==this.endRadius?(clearTimeout(this.anim),this.activeMouse(),this.draw(!0)):(this.draw(),this.time-=0.2,this.anim=setTimeout(function(a){this.update()}.bind(this),this.time));this.radius++;this.line+=0.2},activeMouse:function(){this.content.onmousemove=
function(a){this.mouseMove(a)}.bind(this)},mouseMove:function(a){var b=a.clientX-0.5*window.innerWidth;a=a.clientY-0.5*window.innerHeight;var c=Math.atan2(b,-a),c=Math.round(180/Math.PI*c);0>c&&(c+=360);c+=this.rdecal;Math.round(Math.sqrt(b*b+a*a))>this.radius-50?(this.findRubrique(c),null!==this.current&&(this.title.style.background=this.arcs[this.current].color,this.title.innerHTML=this.current.replace("-"," ").toUpperCase())):(this.current=null,this.title.style.background="none",this.title.innerHTML=
"",this.subTitle.innerHTML="")},findRubrique:function(a){for(var b=this.nRubriques;b--;)a<this.anglesEnd[b]&&a>this.anglesStart[b]&&(this.current=this.rubNames[b])},compute:function(){var a=0,b,c=0,d;for(d in this.arcs)b=this.arcs[d],this.colors[a]=b.color,this.demosNames[a]=b.demos,this.demosIcones[a]=b.icon,this.nDemos[a]=b.demos.length,c+=this.nDemos[a],a++;b=360/c;var e=c=0,a=0;for(d in this.arcs){c=this.nDemos[a]*b;this.rubNames[a]=d;this.anglesStart[a]=e+this.decal+this.rdecal;this.anglesEnd[a]=
e+c-this.decal+this.rdecal;var f=this.anglesStart[a]+0.5*(this.anglesEnd[a]-this.anglesStart[a])-60;this.angles[a]=f;this.points[a]=this.findPoint(f);e+=c;a++}this.nRubriques=a;this.isComputed=!0},findPoint:function(a){var b=a*LTH.ToRad,c=(a+13)*LTH.ToRad;a=(a-13)*LTH.ToRad;for(var d,e=90,f=this.endRadius,g=[],h=0;13>h;h++)0==h?d=this.radialPos(b,f+25):1==h?d=this.radialPos(b,f+70):1==(h&1)?(d=this.radialPos(a,f+e),e+=45):d=this.radialPos(c,f+e),g.push(d);return g},radialPos:function(a,b){return{x:Math.cos(a)*
...
this.time)},updatePins:function(){var a=this.nRubriques,b,c,d;if(this.startPins==this.endPins)clearTimeout(this.anim);else{for(b=this.prevPins.length;b--;)this.prevPins[b].style.display="block";for(b=this.pins.length;b--;)this.pins[b].className="pins pinson",this.prevPins[b]=this.pins[b].childNodes[0];for(;a--;)b=this.points[a],c=this.nDemos[a],d=this.colors[a],this.startPins<c&&(this.liner(b,d,this.startPins),this.addPins(b[this.startPins+1].x,b[this.startPins+1].y,d,this.startPins,a));this.startPins++;
this.anim=setTimeout(function(a){this.updatePins()}.bind(this),this.time)}},liner:function(a,b,c){this.ctx.strokeStyle=b;this.ctx.beginPath();this.ctx.moveTo(a[0].x,a[0].y);0==c&&this.ctx.lineTo(a[1].x,a[1].y);1==c&&(this.ctx.moveTo(a[1].x,a[1].y),this.ctx.lineTo(a[2].x,a[2].y));2==c&&(this.ctx.moveTo(a[1].x,a[1].y),this.ctx.lineTo(a[3].x,a[3].y));3==c&&(this.ctx.moveTo(a[2].x,a[2].y),this.ctx.lineTo(a[4].x,a[4].y));4==c&&(this.ctx.moveTo(a[3].x,a[3].y),this.ctx.lineTo(a[5].x,a[5].y));5==c&&(this.ctx.moveTo(a[4].x,
a[4].y),this.ctx.lineTo(a[6].x,a[6].y));6==c&&(this.ctx.moveTo(a[5].x,a[5].y),this.ctx.lineTo(a[7].x,a[7].y));this.ctx.lineWidth=2;this.ctx.stroke()},addPins:function(a,b,c,d,e){var f=this.pins.length,g=document.createElement("div");g.className="pins";g.style.left=a+"px";g.style.top=b+"px";g.style.background=c;g.name=e+"_"+d;a=document.createElement("div");a.className="pinsin";a.innerHTML=LTH.IconMicro(this.baseColor,this.demosIcones[e][d]);g.appendChild(a);this.pins[f]=g;this.pins[f].onclick=function(a){var b=
a.target.name.substring(0,1);a=a.target.name.substring(2,a.target.name.length);this.main.menu.resetHome(b,a)}.bind(this);this.pins[f].onmouseover=function(a){a.target.style.background="#d2cec8";var b=a.target.name.substring(0,1);a=a.target.name.substring(2,a.target.name.length);this.subTitle.innerHTML=this.demosNames[b][a].replace("_"," ").toUpperCase()}.bind(this);this.pins[f].onmouseout=function(a){a.target.style.background=c;this.subTitle.innerHTML=""}.bind(this);this.pinsContent.appendChild(this.pins[f])}};
LTH.IconMicro=function(a,b){var c=["<svg version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' preserveAspectRatio='none' x='0px' y='0px' width='30px' height='30px' viewBox='0 0 30 30';'>"];switch(b){case 0:c[1]="<g id='Layer'><path fill='#"+a+"' d='M 26 16 L 26 14 22 14 22 10 20 8 16 8 16 4 14 4 14 8 10 8 8 10 8 14 4 14 4 16 8 16 8 20 10 22 14 22 14 26 16 26 16 22 20 22 22 20 22 16 26 16 M 19 10 L 20 11 20 19 19 20 11 20 10 19 10 11 11 10 19 10 Z'/>";break;case 1:c[1]=
"<g id='Layer'><path fill='#"+a+"' d='M 16 11 L 14 11 14 14 11 14 11 16 14 16 14 19 16 19 16 16 19 16 19 14 16 14 16 11 Z'/>";break;case 2:c[1]="<g id='Layer'><path fill='#"+a+"' d='M 23 20 L 22 20 22 12 19 12 19 10 18 10 18 12 16 12 16 19 18 19 18 14 20 14 20 22 23 22 23 20 M 7 22 L 10 22 10 10 12 10 12 19 14 19 14 8 8 8 8 20 7 20 7 22 Z'/>"}c[2]="<use xlink:href='#Layer'/></g></svg>";return c.join("\n")};LTH.logoTimer=null;
...
LTH.Logos(a.baseColor,!0);LTH.logoTimer=setTimeout(a.blinkOpen,150,a)},initHome:function(){this.doc.body.onmousemove=function(a){return!1};this.logo.className="logo";this.content.className="menu home";this.title.style.top="50%";this.blinkOpen(this);this.micrologo.style.display="block";this.main.shader.clear();this.isMenu&&this.resetMenu();this.isHome||(LTH.cRubr=-1,LTH.cFile=0,this.title.innerHTML="LOTH LABS",this.main.labmenu.init(),this.isHome=!0)},resetHome:function(a,b){this.stopBlink();this.micrologo.style.display=
"none";LTH.cRubr=a;this.main.startDemo=b;LTH.cFile=b;this.clearDiv(this.main.labmenu.content);this.isHome=!1;this.initMenu(b);this.main.happ&&history.pushState(null,null,"index.html")},resetMenu:function(){this.main.editor.clear();"shader"===this.main.mode&&(this.main.editorVertex.clear(),this.main.editorFragment.clear());this.main.clearPreview();this.clearDiv(this.zone);this.clearDiv(this.leftMenu);this.content.removeChild(this.leftMenu);this.content.removeChild(this.zone);this.icons=[];this.files=
[];this.buttons=[];this.isMenu=!1},initMenu:function(a){this.doc.body.onmousemove=function(a){this.showHideMenu(a)}.bind(this);this.content.className="menu exemple";this.logo.className="logo lmin";var b="basic";"shaders"===LTH.rubriques[LTH.cRubr]&&(b="shader");this.main.switchMode(b);this.main.resize();this.title.innerHTML="";this.title.style.top="200px";this.initButton();this.initZone();for(var c=LTH.demoNames[LTH.cRubr],d=c.length,e=0;e<d;e++)b=c[e]+".js",this.pushFile(b);this.currentFile=a||0;
...
this.doc.createElement("div");this.leftMenu.className="bottomLeftMenu";this.content.appendChild(this.leftMenu);for(var a,b=0;5>b;b++)a=this.doc.createElement("div"),a.className="b",1<b&&(a.style.display="none"),this.leftMenu.appendChild(a),this.buttons[b]=a;this.buttons[0].innerHTML="N";this.buttons[1].innerHTML="C";this.buttons[2].innerHTML="V";this.buttons[3].innerHTML="+";this.buttons[4].innerHTML="-";var c=this;this.buttons[0].onclick=function(){c.dayNight()};this.buttons[1].onclick=function(){c.showCode()};
this.buttons[2].onclick=function(){c.verticlaHorizon()};this.buttons[3].onclick=function(){c.textPlus()};this.buttons[4].onclick=function(){c.textMoin()}},showCode:function(){this.main.showCode?(this.main.showCode=!1,this.buttons[1].style.textDecoration="none",this.buttons[2].style.display="none",this.buttons[3].style.display="none",this.buttons[4].style.display="none"):(this.main.showCode=!0,this.buttons[1].style.textDecoration="line-through",this.buttons[2].style.display="inline-block",this.buttons[3].style.display=
"inline-block",this.buttons[4].style.display="inline-block");this.main.resize()},dayNight:function(){this.main.day?(this.isNight(),this.buttons[0].innerHTML="N"):(this.isDay(),this.buttons[0].innerHTML="D");this.resetIcon(!0);this.main.switchStyle();this.redrawMini()},verticlaHorizon:function(){"vertical"==this.main.viewType?(this.main.viewType="horizon",this.buttons[2].innerHTML="H"):(this.main.viewType="vertical",this.buttons[2].innerHTML="V");this.main.resize()},textPlus:function(){this.main.scriptText++;
this.main.setTextSize()},textMoin:function(){this.main.scriptText--;this.main.setTextSize()},isDay:function(){this.baseColor="25292e";this.logo.innerHTML=LTH.Logos(this.baseColor);this.main.day=!0;this.main.mainClass="day";this.doc.body.className="day";this.colorSelect="#25292e";this.colorOver="rgba(0,0,0,0.3)"},isNight:function(){this.baseColor="d2cec8";this.logo.innerHTML=LTH.Logos(this.baseColor);this.main.day=!1;this.main.mainClass="night";this.doc.body.className="night";this.colorSelect="#d2cec8";
this.colorOver="rgba(255,255,255,0.3)"},zoneDragOver:function(){this.zone.classList.add("hover");return!1},zoneDragEnd:function(){this.zone.classList.remove("hover");return!1},zoneDrop:function(a){this.zone.classList.remove("hover");a.preventDefault();var b;if(a.dataTransfer.items)for(b=a.dataTransfer.items.length;b--;){var c=a.dataTransfer.items[b].webkitGetAsEntry();c.isFile?this.addFile(a.dataTransfer.items[b].getAsFile()):c.isDirectory&&console.log("dir",a.dataTransfer.items[b].getAsFile(),c.fullPath)}else for(b=
a.dataTransfer.files.length;b--;)this.addFile(a.dataTransfer.files[b])},addFile:function(a){var b=this,c=new FileReader;c.onload=function(c){c=a.name;c.substr(c.lastIndexOf(".")+1,c.length);b.pushFile(c)};c.readAsDataURL(a)},pushFile:function(a){for(var b=this.files.length;b--;)if(a==this.files[b])return;var b=this.icons.length,c=document.createElement("div");c.className="ic";var d=document.createElement("div");d.style.cssText="position:relative; left:10px; top:5px; width:18px; height:18px; pointer-events:none; background-color: none; border:2px solid rgba(0,0,0,0);  border-radius:20px; pointer-events:none;";
var e=document.createElement("div");e.style.cssText="position:relative; left:5px; top:-12px; width:148px; height:20px; pointer-events:none; text-align:right; pointer-events:none;";var f=document.createElement("div");f.style.cssText="position:relative; left:15px; top:-28px; width:8px; height:8px; pointer-events:none; background-color: "+this.colorSelect+";  border-radius:20px;";e.innerHTML=a.substr(0,a.lastIndexOf("."));c.appendChild(d);c.appendChild(e);c.appendChild(f);this.zone.appendChild(c);c.name=
b;c.onclick=function(a){this.openFile(a)}.bind(this);c.ondblclick=function(a){this.openFile(a)}.bind(this);c.onmouseover=function(a){this.iconOver(a)}.bind(this);c.onmouseout=function(a){this.unselected(a)}.bind(this);c.onmouseup=function(a){this.unselected(a)}.bind(this);c.ondragstart=function(a){this.dragstart(a)}.bind(this);c.ondragend=function(a){this.dragend(a)}.bind(this);this.icons[b]=c;this.files[b]=a},iconOver:function(a){a.target.className="ic icover";a.preventDefault();a=a.target.name;
a!==this.currentFile&&(this.icons[a].childNodes[0].style.border="2px solid "+this.colorOver)},unselected:function(a){a.target.className="ic icout";a.preventDefault();a=a.target.name;a!==this.currentFile&&(this.icons[a].childNodes[0].style.border="2px solid rgba(0,0,0,0)")},addIconLink:function(a,b,c){window.URL=window.webkitURL||window.URL;this.currentLink&&(window.URL.revokeObjectURL(this.currentLink.href),this.currentLink=null);this.currentLink=document.createElement("a");this.currentLink.style.cssText=
"position:absolute; top:6px; right:65px; width:120px; height:20px; text-align:center;";this.currentLink.download=b;this.currentLink.href=window.URL.createObjectURL(a);this.currentLink.dataset.downloadurl=[c,this.currentLink.download,this.currentLink.href].join(":")},dragstart:function(a){null!==this.currentLink&&a.dataTransfer.setData("DownloadURL",this.currentLink.dataset.downloadurl)},dragend:function(a){this.resetModified()},openFile:function(a){a.preventDefault();a=a.target.name;this.currentFile!==
a&&(LTH.cFile=a||0,this.resetModified(),this.currentFile=a,this.main.loadFile("demos/"+LTH.rubriques[LTH.cRubr]+"/"+this.files[a]),this.resetIcon())},resetIcon:function(a){for(var b=this.icons.length,c;b--;)c=this.icons[b].childNodes,c[0].style.border=b==this.currentFile?b==this.inModif?"2px solid "+this.colorModif:"2px solid "+this.colorSelect:"2px solid rgba(0,0,0,0)",a&&(b==this.inModif?(c[1].style.color=this.colorModif,c[2].style.backgroundColor=this.colorModif):(c[1].style.color=this.colorSelect,
