...
LTH.Menu.prototype={constructor:LTH.Menu,initLogo:function(){this.logo=this.doc.createElement("div");this.logo.className="logo";this.content.appendChild(this.logo);this.logo.innerHTML=LTH.Logos("d2cec8");this.title=this.doc.createElement("div");this.title.innerHTML="LOTH LABS";this.title.className="title";this.content.appendChild(this.title);this.logo.onmousedown=function(a){this.initHome(a)}.bind(this);this.logo.onmouseover=function(a){this.isHome||(this.title.innerHTML="BACK HOME")}.bind(this);
this.logo.onmouseout=function(a){this.isHome||(this.title.innerHTML=LTH.rubriques[LTH.cRubr].toUpperCase())}.bind(this)},initHome:function(){this.doc.body.onmousemove=function(a){return!1};this.content.className="menu home";this.main.shader.clear();this.isMenu&&this.resetMenu();if(!this.isHome){LTH.cRubr=-1;LTH.cFile=0;this.title.innerHTML="LOTH LABS";this.home=this.doc.createElement("div");this.home.style.cssText="position:absolute; left:10%; top:160px; width:80%; height:400px; text-align:center;";
this.content.appendChild(this.home);for(var a,b=0;b<LTH.rubriques.length;b++)a=this.doc.createElement("div"),a.className="rub",a.name=b,a.innerHTML=LTH.rubriques[b].toUpperCase(),a.onclick=function(a){this.resetHome(a)}.bind(this),a.onmouseover=function(a){a.target.className="rub rubover"},a.onmouseout=function(a){a.target.className="rub"},this.home.appendChild(a);this.isHome=!0}},resetHome:function(a){LTH.cRubr=a.target.name;this.clearDiv(this.home);this.content.removeChild(this.home);this.isHome=
!1;this.initMenu();this.main.happ&&history.pushState(null,null,"index.html");a.preventDefault()},resetMenu:function(){this.main.editor.clear();"shader"===this.main.mode&&(this.main.editorVertex.clear(),this.main.editorFragment.clear());this.main.clearPreview();this.clearDiv(this.zone);this.clearDiv(this.leftMenu);this.content.removeChild(this.leftMenu);this.content.removeChild(this.zone);this.icons=[];this.files=[];this.buttons=[];this.isMenu=!1},initMenu:function(){this.doc.body.onmousemove=function(a){this.showHideMenu(a)}.bind(this);
this.content.className="menu exemple";this.logo.className="logo lmin";var a="basic";"shaders"===LTH.rubriques[LTH.cRubr]&&(a="shader");this.main.switchMode(a);this.main.resize();this.title.innerHTML="";this.initButton();this.initZone();for(var b=LTH.demoNames[LTH.cRubr],c=b.length,d=0;d<c;d++)a=b[d]+".js",this.pushFile(a);this.currentFile=this.main.startDemo||0;this.main.loadFile("demos/"+LTH.rubriques[LTH.cRubr]+"/"+this.files[this.currentFile]);this.resetIcon();this.isMenu=!0},clearDiv:function(a){for(;a.firstChild;)a.removeChild(a.firstChild)},
initZone:function(){this.zone=this.doc.createElement("div");this.zone.className="zone";this.content.appendChild(this.zone);var a=this;this.zone.ondragover=function(b){a.zoneDragOver(b)};this.zone.ondragend=function(b){a.zoneDragEnd(b)};this.zone.ondrop=function(b){a.zoneDrop(b)}},initButton:function(){this.leftMenu=this.doc.createElement("div");this.leftMenu.className="bottomLeftMenu";this.content.appendChild(this.leftMenu);for(var a,b=0;5>b;b++)a=this.doc.createElement("div"),a.className="b",1<b&&
(a.style.display="none"),this.leftMenu.appendChild(a),this.buttons[b]=a;this.buttons[0].innerHTML="N";this.buttons[1].innerHTML="C";this.buttons[2].innerHTML="V";this.buttons[3].innerHTML="+";this.buttons[4].innerHTML="-";var c=this;this.buttons[0].onclick=function(){c.dayNight()};this.buttons[1].onclick=function(){c.showCode()};this.buttons[2].onclick=function(){c.verticlaHorizon()};this.buttons[3].onclick=function(){c.textPlus()};this.buttons[4].onclick=function(){c.textMoin()}},showCode:function(){this.main.showCode?
(this.main.showCode=!1,this.buttons[1].style.textDecoration="none",this.buttons[2].style.display="none",this.buttons[3].style.display="none",this.buttons[4].style.display="none"):(this.main.showCode=!0,this.buttons[1].style.textDecoration="line-through",this.buttons[2].style.display="inline-block",this.buttons[3].style.display="inline-block",this.buttons[4].style.display="inline-block");this.main.resize()},dayNight:function(){this.main.day?(this.isNight(),this.buttons[0].innerHTML="N"):(this.isDay(),
this.buttons[0].innerHTML="D");this.resetIcon(!0);this.main.switchStyle()},verticlaHorizon:function(){"vertical"==this.main.viewType?(this.main.viewType="horizon",this.buttons[2].innerHTML="H"):(this.main.viewType="vertical",this.buttons[2].innerHTML="V");this.main.resize()},textPlus:function(){this.main.scriptText++;this.main.setTextSize()},textMoin:function(){this.main.scriptText--;this.main.setTextSize()},isDay:function(){this.logo.innerHTML=LTH.Logos("25292e");this.main.day=!0;this.main.mainClass=
"day";this.doc.body.className="day";this.colorSelect="#25292e";this.colorOver="rgba(0,0,0,0.3)"},isNight:function(){this.logo.innerHTML=LTH.Logos("d2cec8");this.main.day=!1;this.main.mainClass="night";this.doc.body.className="night";this.colorSelect="#d2cec8";this.colorOver="rgba(255,255,255,0.3)"},zoneDragOver:function(){this.zone.classList.add("hover");return!1},zoneDragEnd:function(){this.zone.classList.remove("hover");return!1},zoneDrop:function(a){this.zone.classList.remove("hover");a.preventDefault();
var b;if(a.dataTransfer.items)for(b=a.dataTransfer.items.length;b--;){var c=a.dataTransfer.items[b].webkitGetAsEntry();c.isFile?this.addFile(a.dataTransfer.items[b].getAsFile()):c.isDirectory&&console.log("dir",a.dataTransfer.items[b].getAsFile(),c.fullPath)}else for(b=a.dataTransfer.files.length;b--;)this.addFile(a.dataTransfer.files[b])},addFile:function(a){var b=this,c=new FileReader;c.onload=function(c){c=a.name;c.substr(c.lastIndexOf(".")+1,c.length);b.pushFile(c)};c.readAsDataURL(a)},pushFile:function(a){for(var b=
this.files.length;b--;)if(a==this.files[b])return;var b=this.icons.length,c=document.createElement("div");c.className="ic";var d=document.createElement("div");d.style.cssText="position:relative; left:10px; top:5px; width:18px; height:18px; pointer-events:none; background-color: none; border:2px solid rgba(0,0,0,0);  border-radius:20px;";var f=document.createElement("div");f.style.cssText="position:relative; left:30px; top:-12px; width:calc(100% - 40px); height:20px; pointer-events:none; text-align:right;";
var e=document.createElement("div");e.style.cssText="position:relative; left:15px; top:-28px; width:8px; height:8px; pointer-events:none; background-color: "+this.colorSelect+";  border-radius:20px;";f.innerHTML=a.substr(0,a.lastIndexOf("."));c.appendChild(d);c.appendChild(f);c.appendChild(e);this.zone.appendChild(c);c.name=b;c.onclick=function(a){this.openFile(a)}.bind(this);c.ondblclick=function(a){this.openFile(a)}.bind(this);c.onmouseover=function(a){this.iconOver(a)}.bind(this);c.onmouseout=
