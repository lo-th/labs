...
!0;this.fileSystem.load(a)},openFile:function(a){this.fileSystem.open(a)},createLink:function(a,b,c){this.menu.addIconLink(a,b,c)},callSave:function(){this.fileSystem.save()},blur:function(){this.editor.blur()}};
...
d;this.anglesStart[a]=e+this.decal+this.rdecal;this.anglesEnd[a]=e+c-this.decal+this.rdecal;var f=this.anglesStart[a]+0.5*(this.anglesEnd[a]-this.anglesStart[a])-60;this.angles[a]=f;this.points[a]=this.findPoint(f);e+=c;a++}this.nRubriques=a;this.isComputed=!0},findPoint:function(a){var b=a*LTH.ToRad,c=(a+13)*LTH.ToRad;a=(a-13)*LTH.ToRad;for(var d,e=90,f=this.endRadius-10,g=[],h=0;13>h;h++)0==h?d=this.radialPos(b,f+25):1==h?d=this.radialPos(b,f+70):1==(h&1)?(d=this.radialPos(a,f+e),e+=45):d=this.radialPos(c,
