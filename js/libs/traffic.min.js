...
nativeLastIndexOf=ArrayProto.lastIndexOf,nativeIsArray=Array.isArray,nativeKeys=Object.keys,nativeBind=FuncProto.bind,TRAFFIC={settings:{lightsFlipInterval:20,gridSize:32,defaultTimeFactor:5}};TRAFFIC.abs=Math.abs;TRAFFIC.sqrt=Math.sqrt;TRAFFIC.atan2=Math.atan2;TRAFFIC.random=Math.random;TRAFFIC.max=Math.max;TRAFFIC.min=Math.min;TRAFFIC.PI=Math.PI;TRAFFIC.binding=function(a,b){return function(){return a.apply(b,arguments)}};
TRAFFIC.bind=function(a,b){var c,d;if(nativeBind&&a.bind===nativeBind)return nativeBind.apply(a,slice.call(arguments,1));c=slice.call(arguments,2);return d=function(){if(!(this instanceof d))return a.apply(b,c.concat(slice.call(arguments)));ctor.prototype=a.prototype;var e=new ctor;ctor.prototype=null;var f=a.apply(e,c.concat(slice.call(arguments)));return Object(f)===f?f:e}};TRAFFIC.indexOf=[].indexOf||function(a){for(var b=0,c=this.length;b<c;b++)if(b in this&&this[b]===a)return b;return-1};
TRAFFIC.rand=function(a,b){null==b&&(b=a,a=0);return a+Math.floor(Math.random()*(b-a+1))};TRAFFIC.sample=function(a,b,c){return null==b||c?(a.length!==+a.length&&(a=TRAFFIC.values(a)),a[TRAFFIC.rand(a.length-1)]):TRAFFIC.shuffle(a).slice(0,Math.max(0,b))};TRAFFIC.shuffle=function(a){var b,c=0,d=[];TRAFFIC.each(a,function(a){b=TRAFFIC.rand(c++);d[c-1]=d[b];d[b]=a});return d};TRAFFIC.idCounter=0;TRAFFIC.uniqueId=function(a){var b=++TRAFFIC.idCounter+"";return a?a+b:b};
TRAFFIC.extend=function(a){TRAFFIC.each(slice.call(arguments,1),function(b){if(b)for(var c in b)a[c]=b[c]});return a};TRAFFIC.reduce=function(a,b,c,d){var e=2<arguments.length;null==a&&(a=[]);if(nativeReduce&&a.reduce===nativeReduce)return d&&(b=TRAFFIC.bind(b,d)),e?a.reduce(b,c):a.reduce(b);TRAFFIC.each(a,function(a,g,h){e?c=b.call(d,c,a,g,h):(c=a,e=!0)});return c};
...
a=TRAFFIC.sample(this.roads.all());if(null!=a&&(a=TRAFFIC.sample(a.lanes),null!=a))return this.addCar(new TRAFFIC.Car(a))},removeRandomCar:function(){var a;a=TRAFFIC.sample(this.cars.all());if(null!=a)return this.removeCar(a)}};TRAFFIC.Car=function(a,b){this.id=TRAFFIC.uniqueId("car");this.color=(300+240*TRAFFIC.random()|0)%360;this._speed=0;this.width=1.7;this.length=3+2*TRAFFIC.random();this.maxSpeed=30;this.s0=2;this.timeHeadway=1.5;this.maxAcceleration=1;this.maxDeceleration=3;this.trajectory=new TRAFFIC.Trajectory(this,a,b);this.alive=!0;this.preferedLane=null;Object.defineProperty(this,"coords",{get:function(){return this.trajectory.coords}});Object.defineProperty(this,"speed",{get:function(){return this._speed},set:function(a){0>
a&&(a=0);a>this.maxSpeed&&(a=this.maxSpeed);return this._speed=a}});Object.defineProperty(this,"direction",{get:function(){return this.trajectory.direction}})};
