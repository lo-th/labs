'use strict';var LTH={CODES:"full serious rot terrain liquid ammo oimo crowd".split(" "),rubriques:[],demoNames:[],libsNames:[],ARCS:{},cRubr:-1,cFile:-1};LTH.ToRad=Math.PI/180;var esprima=esprima||{};esprima.parse=esprima.parse||{};var CodeMirror=CodeMirror||{},GRAD=GRAD||{},history,main;window.onload=init;function init(){main=new LTH.Main}function endTranscode(){main.menu.initHomeland(main.transcode.isWebGl)}
