...
LTH.Main=function(){this.menuSize=60;this.doc=document;this.doc.body.className="night";this.doc.body.ondragover=function(a){return!1};this.doc.body.onmousemove=showHideMenu;this.day=!1;this.mode="basic";this.startDemo=0;this.numLesson=4;this.items=[];this.showCode=!1;this.viewType="vertical";this.scriptText=14;this.currentLesson=-1;this.isFirst=this.codeLoaded=!1;this.previewMain=this.previewDoc=this.preview=this.editorFragment=this.editorVertex=this.editor=this.menu=null;this.happ=!1;this.init()};
...
this.codeLoaded&&this.previewTheme()},previewTheme:function(){this.previewDoc.body.className=this.day?"day":"night";this.previewMain&&(this.day?this.previewMain.v.colorBack(13815496):this.previewMain.v.colorBack(2435374))},previewClearFocus:function(){for(var a=this.previewDoc.getElementsByTagName("*"),b=0,c;c=a[b++];)c.id&&c.blur()},clearPreview:function(){null!==this.preview&&(this.doc.body.removeChild(this.preview),this.previewMain=this.previewDoc=this.preview=null)},initPreview:function(){this.preview=
this.doc.createElement("iframe");this.preview.className="preview";this.preview.style.cssText="position:absolute;  border:none; pointer-events:auto; background:none; z-index:0; display:none;";this.doc.body.appendChild(this.preview)},update:function(a){if(""!==a){this.codeLoaded=!1;this.clearPreview();this.initPreview();this.tmpcode=a;a="<script src='src/Vue3d.js'>\x3c/script>";var b="<script src='js/libs/three.js'>\x3c/script>";isMain&&(a="<script src='build/v3d.min.js'>\x3c/script>",b="<script src='js/libs/three.min.js'>\x3c/script>");
for(var c="",d=LTH.option[LTH.cRubrique][LTH.cFile],g=d.length;g--;)c+="<script src='js/libs/"+d[g]+".min.js'>\x3c/script>";a=["<!DOCTYPE html>\n<html lang='en'>\n<head>\n<title>prev</title>\n<meta charset='utf-8'>\n<link rel='stylesheet' href='css/consolas.css'>\n<link rel='stylesheet' href='css/basic.css'>",b,"<script src='js/libs/three.post.js'>\x3c/script>",c,a,"<script id='shader'>\x3c/script>\n</head><body>\n<script> var main = null; var canvas = document.createElement('canvas'); document.body.appendChild( canvas ); \x3c/script>\n</body></html>"].join("\n");
var e=this;try{this.previewDoc=this.preview.contentDocument||this.preview.contentWindow.document,this.previewMain=this.preview.contentWindow}catch(f){console.log("error",f)}finally{this.previewDoc.open("text/html","replace"),this.previewDoc.write(a),this.previewDoc.close(this.preview),e=this,this.previewMain.onload=function(a){e.frameLoaded()}}}},frameLoaded:function(){console.log("loaded");"shader"===this.mode&&(this.previewMain.main=this);var a=this.previewDoc.getElementsByTagName("head")[0],b=
this.previewDoc.createElement("script");b.name="topScript";b.id="topScript";b.type="text/javascript";b.charset="utf-8";b.text=this.tmpcode;a.appendChild(b);this.tmpcode="";this.preview.style.display="block";this.codeLoaded=!0;this.previewTheme();this.resize();this.isFirst?this.isFirst=!1:this.showModif()},checkCurrent:function(){for(var a=0;a<this.numLesson;a++)this.items[a].style.background=this.items[a].name==this.currentLesson?"#881288":"#121212"},loadFile:function(a){this.isFirst=!0;this.fileSystem.load(a)},
openFile:function(a){this.fileSystem.open(a)},createLink:function(a,b,c){this.menu.addIconLink(a,b,c)},showModif:function(){this.menu.modified()},callSave:function(){this.fileSystem.save()}};LTH.ShaderToy=function(a){this.main=a;this.retour=document.createElement("div");this.retour.innerHTML=".join('&#92;n')";this.shaderName="";this.shaderBase=null;this.uniformValues={};this.uniformColors={};this.isShaderReady=!1};
