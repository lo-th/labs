...
e=0;e<d.length;e++){var f=d[e],g=document.createElement("div");g.className="esprima-error";g.textContent=f.message.replace(/Line [0-9]+: /,"");var h=f.lineNumber-1;c.errorLines.push(h);b.addLineClass(h,"background","errorLine");var k=b.addLineWidget(h,g);c.widgets.push(k)}}catch(l){g=document.createElement("div"),g.className="esprima-error",g.textContent=l.message.replace(/Line [0-9]+: /,""),h=l.lineNumber-1,c.errorLines.push(h),b.addLineClass(h,"background","errorLine"),k=b.addLineWidget(h,g),c.widgets.push(k)}return 0===
