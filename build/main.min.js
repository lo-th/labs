...
this.content.removeChild(this.topColor);this.icons=[];this.files=[];this.buttons=[];this.isMenu=!1},initMenu:function(){this.doc.body.onmousemove=function(a){this.showHideMenu(a)}.bind(this);this.content.className="menu exemple";this.logo.className="logo lmin";var a="basic";"shaders"===LTH.rubriques[LTH.cRubr]&&(a="shader");this.main.switchMode(a);this.main.resize();this.title.innerHTML="";this.title.style.top="200px";this.initButton();this.initZone();for(var b=LTH.demoNames[LTH.cRubr],c=b.length,
e=0;e<c;e++)a=b[e]+".js",this.pushFile(a);this.main.loadFile("demos/"+LTH.rubriques[LTH.cRubr]+"/"+this.files[LTH.cFile]);this.resetIcon();this.isMenu=!0},clearDiv:function(a){for(;a.firstChild;)a.removeChild(a.firstChild)},initZone:function(){this.zone=this.doc.createElement("div");this.zone.className="zone";this.content.appendChild(this.zone);var a=this;this.zone.ondragover=function(b){a.zoneDragOver(b)};this.zone.ondragend=function(b){a.zoneDragEnd(b)};this.zone.ondrop=function(b){a.zoneDrop(b)}},
initButton:function(){this.topColor=this.doc.createElement("div");this.topColor.className="topColor";this.topColor.style.background=this.main.labmenu.colors[LTH.cRubr];this.content.appendChild(this.topColor);this.leftMenu=this.doc.createElement("div");this.leftMenu.className="bottomLeftMenu";this.content.appendChild(this.leftMenu);for(var a,b=0;5>b;b++)a=this.doc.createElement("div"),a.className="b",1<b&&(a.style.display="none"),this.leftMenu.appendChild(a),this.buttons[b]=a;this.buttons[0].innerHTML=
"N";this.buttons[1].innerHTML="C";this.buttons[2].innerHTML="V";this.buttons[3].innerHTML="+";this.buttons[4].innerHTML="-";var c=this;this.buttons[0].onclick=function(){c.dayNight()};this.buttons[1].onclick=function(){c.showCode()};this.buttons[2].onclick=function(){c.verticlaHorizon()};this.buttons[3].onclick=function(){c.textPlus()};this.buttons[4].onclick=function(){c.textMoin()}},showCode:function(){this.main.showCode?(this.main.showCode=!1,this.buttons[1].style.textDecoration="none",this.buttons[2].style.display=
"none",this.buttons[3].style.display="none",this.buttons[4].style.display="none"):(this.main.showCode=!0,this.buttons[1].style.textDecoration="line-through",this.buttons[2].style.display="inline-block",this.buttons[3].style.display="inline-block",this.buttons[4].style.display="inline-block");this.main.resize()},dayNight:function(){this.main.day?(this.isNight(),this.buttons[0].innerHTML="N"):(this.isDay(),this.buttons[0].innerHTML="D");this.resetIcon(!0);this.main.switchStyle();this.redrawMini()},
verticlaHorizon:function(){"vertical"==this.main.viewType?(this.main.viewType="horizon",this.buttons[2].innerHTML="H"):(this.main.viewType="vertical",this.buttons[2].innerHTML="V");this.main.resize()},textPlus:function(){this.main.scriptText++;this.main.setTextSize()},textMoin:function(){this.main.scriptText--;this.main.setTextSize()},isDay:function(){this.baseColor="25292e";this.main.labmenu.baseColor="25292e";this.main.labmenu.topColor="d2cec8";this.logo.innerHTML=LTH.Logos(this.baseColor);this.main.day=
!0;this.main.mainClass="day";this.doc.body.className="day";this.colorSelect="#25292e";this.colorOver="rgba(0,0,0,0.3)"},isNight:function(){this.baseColor="d2cec8";this.main.labmenu.baseColor="d2cec8";this.main.labmenu.topColor="25292e";this.logo.innerHTML=LTH.Logos(this.baseColor);this.main.day=!1;this.main.mainClass="night";this.doc.body.className="night";this.colorSelect="#d2cec8";this.colorOver="rgba(255,255,255,0.3)"},zoneDragOver:function(){this.zone.classList.add("hover");return!1},zoneDragEnd:function(){this.zone.classList.remove("hover");
return!1},zoneDrop:function(a){this.zone.classList.remove("hover");a.preventDefault();var b;if(a.dataTransfer.items)for(b=a.dataTransfer.items.length;b--;){var c=a.dataTransfer.items[b].webkitGetAsEntry();c.isFile?this.addFile(a.dataTransfer.items[b].getAsFile()):c.isDirectory&&console.log("dir",a.dataTransfer.items[b].getAsFile(),c.fullPath)}else for(b=a.dataTransfer.files.length;b--;)this.addFile(a.dataTransfer.files[b])},addFile:function(a){var b=this,c=new FileReader;c.onload=function(c){c=a.name;
c.substr(c.lastIndexOf(".")+1,c.length);b.pushFile(c)};c.readAsDataURL(a)},pushFile:function(a){for(var b=this.files.length;b--;)if(a==this.files[b])return;var b=this.icons.length,c=document.createElement("div");c.className="ic";var e=document.createElement("div");e.style.cssText="position:relative; left:10px; top:5px; width:18px; height:18px; pointer-events:none; background-color: none; border:2px solid rgba(0,0,0,0);  border-radius:20px; pointer-events:none;";var d=document.createElement("div");
d.style.cssText="position:relative; left:5px; top:-12px; width:148px; height:20px; pointer-events:none; text-align:right; pointer-events:none;";var f=document.createElement("div");f.style.cssText="position:relative; left:15px; top:-28px; width:8px; height:8px; pointer-events:none; background-color: "+this.colorSelect+";  border-radius:20px;";d.innerHTML=a.substr(0,a.lastIndexOf("."));c.appendChild(e);c.appendChild(d);c.appendChild(f);this.zone.appendChild(c);c.name=b;c.onclick=function(a){this.openFile(a)}.bind(this);
c.ondblclick=function(a){this.openFile(a)}.bind(this);c.onmouseover=function(a){this.iconOver(a)}.bind(this);c.onmouseout=function(a){this.unselected(a)}.bind(this);c.onmouseup=function(a){this.unselected(a)}.bind(this);c.ondragstart=function(a){this.dragstart(a)}.bind(this);c.ondragend=function(a){this.dragend(a)}.bind(this);this.icons[b]=c;this.files[b]=a},iconOver:function(a){a.target.className="ic icover";var b=a.target.name;b!==LTH.cFile&&(this.icons[b].childNodes[0].style.border="2px solid "+
this.colorOver);a.preventDefault()},unselected:function(a){a.target.className="ic icout";var b=a.target.name;b!==LTH.cFile&&(this.icons[b].childNodes[0].style.border="2px solid rgba(0,0,0,0)");a.preventDefault()},addIconLink:function(a,b,c){window.URL=window.webkitURL||window.URL;this.currentLink&&(window.URL.revokeObjectURL(this.currentLink.href),this.currentLink=null);this.currentLink=document.createElement("a");this.currentLink.style.cssText="position:absolute; top:6px; right:65px; width:120px; height:20px; text-align:center;";
this.currentLink.download=b;this.currentLink.href=window.URL.createObjectURL(a);this.currentLink.dataset.downloadurl=[c,this.currentLink.download,this.currentLink.href].join(":")},dragstart:function(a){null!==this.currentLink&&a.dataTransfer.setData("DownloadURL",this.currentLink.dataset.downloadurl)},dragend:function(a){this.resetModified()},openFile:function(a){a.preventDefault();a=a.target.name;LTH.cFile!==a&&(LTH.cFile=a,this.resetModified(),this.main.loadFile("demos/"+LTH.rubriques[LTH.cRubr]+
"/"+this.files[a]),this.resetIcon())},resetIcon:function(a){for(var b=this.icons.length,c;b--;)c=this.icons[b].childNodes,c[0].style.border=b==LTH.cFile?b==this.inModif?"2px solid "+this.colorModif:"2px solid "+this.colorSelect:"2px solid rgba(0,0,0,0)",a&&(b==this.inModif?(c[1].style.color=this.colorModif,c[2].style.backgroundColor=this.colorModif):(c[1].style.color=this.colorSelect,c[2].style.backgroundColor=this.colorSelect))},modified:function(){this.inModif=LTH.cFile;var a=this.icons[LTH.cFile].childNodes;
this.icons[LTH.cFile].draggable=!0;this.icons[LTH.cFile].classList.add("dragout");a[0].style.border="2px solid "+this.colorModif;a[1].style.color=this.colorModif;a[2].style.backgroundColor=this.colorModif;this.main.callSave()},resetModified:function(){this.inModif=-1;for(var a=this.icons.length,b;a--;)this.icons[a].draggable=!1,this.icons[a].classList.remove("dragout"),b=this.icons[a].childNodes,a==LTH.cFile&&(b[0].style.border="1px solid "+this.colorSelect),b[1].style.color=this.colorSelect,b[2].style.backgroundColor=
