...
V.round=Math.round;V.lerp=function(a,b,c){return a+(b-a)*c};V.rand=function(a,b,c){return 1*V.lerp(a,b,Math.random()).toFixed(c||3)};V.randInt=function(a,b,c){return 1*V.lerp(a,b,Math.random()).toFixed(c||0)};V.randColor=function(){return"#"+Math.floor(16777215*Math.random()).toString(16)};V.MeshList="plane sphere skull skullhigh head woman babe".split(" ");V.Main=null;
...
a>Math.PI&&(a-=V.TwoPI);a<-Math.PI&&(a+=V.TwoPI);return a}};V.Cursor=function(){this.current="auto";this.type={drag:"url(images/cursor/hand.png) 16 16,auto",draw:"url(images/cursor/draw.png) 16 16,auto",cut:"url(images/cursor/cut.png) 0 30,auto",rotate:"url(images/cursor/rotate.png) 16 16,auto",move:"move",auto:"auto"}};V.Cursor.prototype={constructor:V.Cursor,change:function(a){a=a||"auto";a!==this.current&&(this.current=a,document.body.style.cursor=this.type[this.current])}};
...
return a=6>a.length?"#0"+a:"#"+a};var dat;V.Gui=function(a){this.gui=new dat.GUI;this.tmp={};a&&this.model3d()};
...
"../../js/libs/oimo.min.js";d=1E3;f=e=10;g=0;l=8;h=3;this.update=this.upOimo;this.postMess=this.postOimo;break;case "ammo":c="js/worker/ammo_worker.js";k="../../js/libs/ammo.min.js";d=1E3;f=e=10;g=0;l=8;h=3;this.update=this.upAmmo;this.postMess=this.postAmmo;break;case "traffic":c="js/worker/traffic_worker.js",k="../../js/libs/traffic.min.js",d=1E3,f=e=10,g=0,h=l=3,this.update=this.upTraffic,this.postMess=this.postTraffic}window.top.main.transcode.useTrans&&(k=window.top.main.transcode.codes[this.name]);
this.w=new Worker(c);this.w.postMessage=this.w.webkitPostMessage||this.w.postMessage;this.w.onmessage=function(a){this.update(a)}.bind(this);this.ar=new V.AR32(d*l);this.dr=new V.AR32(e*h);this.pr=new V.AR32(g*h);this.drn=new V.AR32(f);this.drc=new V.AR32(f);this.prn=new V.AR32(f);this.d=[16.667,0,0];this.isReady=!1;this.fps=0;this.w.postMessage({m:"init",url:k})};
...
b.getLength()!==c&&b.addNum(c);for(d=c;d--;)c=2*d,b.move(d,this.pr[c],0,this.pr[c+1]);b.update()}this.computeTime()}},postLiquid:function(){this.w.postMessage({m:"run",prn:this.prn,ar:this.ar,pr:this.pr},[this.ar.buffer,this.pr.buffer])},upAmmo:function(a){if(a.data.init)this.postMess();else{a.data.w&&!this.isReady&&(this.isReady=!0);this.fps=a.data.fps;this.ar=a.data.ar;a=this.root.meshs;for(var b=a.length,c;b--;)c=8*b,this.ar[c]&&(a[b].position.set(this.ar[c+1],this.ar[c+2],this.ar[c+3]),"BLOB"!==
a.type&&a[b].quaternion.set(this.ar[c+4],this.ar[c+5],this.ar[c+6],this.ar[c+7]));this.computeTime()}},postAmmo:function(){this.w.postMessage({m:"run",m2:this.msg,drn:this.drn,drc:this.drc,ar:this.ar,dr:this.dr},[this.ar.buffer])},upOimo:function(a){if(a.data.init)this.postMess();else{a.data.w&&!this.isReady&&(this.isReady=!0);this.fps=a.data.fps;this.ar=a.data.ar;a=this.root.meshs;for(var b=a.length,c;b--;)c=8*b,this.ar[c]&&(a[b].position.set(this.ar[c+1],this.ar[c+2],this.ar[c+3]),"BLOB"!==a.type&&
a[b].quaternion.set(this.ar[c+4],this.ar[c+5],this.ar[c+6],this.ar[c+7]));this.computeTime()}},postOimo:function(){this.w.postMessage({m:"run",m2:this.msg,drn:this.drn,drc:this.drc,ar:this.ar,dr:this.dr},[this.ar.buffer])},room:function(a){var b=0.5*a.h-a.m;this.w.postMessage({m:"room",obj:{n:5,size:[a.w-a.m,a.m,a.d-a.m,a.w+a.m,a.h,a.m,a.w+a.m,a.h,a.m,a.m,a.h,a.d-a.m,a.m,a.h,a.d-a.m],pos:[0,0.5*-a.m,0,0,b,0.5*-a.d,0,b,0.5*a.d,0.5*-a.w,b,0,0.5*a.w,b,0]}});v.addSolid({type:"box",size:[a.w-a.m,a.h-a.m,
a.d-a.m],pos:[0,b+0.5*a.m,0]});v.addSolid({type:"box",size:[a.w+a.m,a.h,a.d+a.m],pos:[0,b,0]})},add:function(a){this.w.postMessage({m:"add",obj:a})},addParticle:function(a){this.w.postMessage({m:"addParticle",obj:a})},post:function(a){this.w.postMessage(a)},chaine:function(a){a.close&&(this.drc[0]=1);for(var b=0.5*a.points.length,c=this.drn[0]=b;c--;)b=2*c,this.dr[b]=a.points[b],this.dr[b+1]=a.points[b+1];this.updateDecal()},updateDecal:function(){this.post({m:"updecal",dr:this.dr,drn:this.drn,drc:this.drc})}};
