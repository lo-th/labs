...
this.postEffect=new V.PostEffect(this,"distortion",!1)},deformSsao:function(a,b){this.postEffect.deformSsao(a,b)},mirror:function(a){this.groundMirror=new THREE.Mirror(v.renderer,v.nav.camera,{clipBias:0.003,textureWidth:this.dimentions.w,textureHeight:this.dimentions.h,color:7829367,alpha:0.02,power:1,radius:1});var b=new THREE.Mesh(this.geo.plane,this.groundMirror.material);a=a||100;b.scale.set(a,a,a);b.add(this.groundMirror);b.rotateX(-V.PI90);this.scene.add(b)},resize:function(){this.dimentions.w=
