...
this.icons.length,c=document.createElement("div");c.className="ic";var d=document.createElement("div");d.style.cssText="position:relative; left:10px; top:5px; width:18px; height:18px; pointer-events:none; background-color: none; border:2px solid rgba(0,0,0,0);  border-radius:20px;";var e=document.createElement("div");e.style.cssText="position:relative; left:30px; top:-12px; width:calc(100% - 40px); height:20px; pointer-events:none; text-align:right;";var f=document.createElement("div");f.style.cssText=
"position:relative; left:15px; top:-28px; width:8px; height:8px; pointer-events:none; background-color: "+this.colorSelect+";  border-radius:20px;";e.innerHTML=a.substr(0,a.lastIndexOf("."));c.appendChild(d);c.appendChild(e);c.appendChild(f);this.zone.appendChild(c);c.name=b;c.onclick=function(a){this.openFile(a)}.bind(this);c.ondblclick=function(a){this.openFile(a)}.bind(this);c.onmouseover=function(a){this.iconOver(a)}.bind(this);c.onmouseout=function(a){this.unselected(a)}.bind(this);c.onmouseup=
...
b.open("GET",a,!0);b.send()},load:function(a,b){a.substring(a.lastIndexOf(".")+1,a.length);var c=a.substring(a.lastIndexOf("/")+1,a.lastIndexOf(".")),d;window.XMLHttpRequest?d=new XMLHttpRequest:window.ActiveXObject&&(d=new ActiveXObject("Microsoft.XMLHTTP"));d.onload=function(a){this.process(c,d.responseText,b)}.bind(this);d.open("GET",a,!0);d.send()},open:function(a,b){var c=a.name,d=new FileReader,e=this;d.onload=function(a){e.process(c,a.target.result,b)};d.readAsText(a.file)},save:function(){var a=
new Blob([this.main.editor.get()],{type:"application/text/javascript;charset=utf-8"});this.main.createLink(a,this.main.editor.currentName+".js","application/text/javascript;charset=utf-8")},process:function(a,b,c){c?this.main.shader.deCompacte(a,b):(this.main.editor.editor.setValue(b),this.main.editor.currentName=a)}};
