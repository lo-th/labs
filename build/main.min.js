...
break;case 4:c[1]="<path fill='#"+a+"' d='M 26 16 L 26 14 16 4 14 4 4 14 4 16 14 26 16 26 26 16 M 6 15 L 15 6 24 15 15 24 6 15 M 16 10 L 14 10 14 16 16 16 16 10 M 16 18 L 14 18 14 20 16 20 16 18 Z'/>";break;case 5:c[1]="<path fill='#"+a+"' d='M 16 11 L 14 11 14 14 11 14 11 16 14 16 14 19 16 19 16 16 19 16 19 14 16 14 16 11 Z'/>";break;case 6:c[1]="<path fill='#"+a+"' d='M 16 11 L 14 11 14 14 11 14 11 16 14 16 14 19 16 19 16 16 19 16 19 14 16 14 16 11 Z'/>";break;case 7:c[1]="<path fill='#"+a+"' d='M 16 11 L 14 11 14 14 11 14 11 16 14 16 14 19 16 19 16 16 19 16 19 14 16 14 16 11 Z'/>";
...
this.icons.length,c=document.createElement("div");c.className="ic";var d=document.createElement("div");d.style.cssText="position:relative; left:10px; top:5px; width:18px; height:18px; pointer-events:none; background-color: none; border:2px solid rgba(0,0,0,0);  border-radius:20px; pointer-events:none;";var e=document.createElement("div");e.style.cssText="position:relative; left:5px; top:-12px; width:148px; height:20px; pointer-events:none; text-align:right; pointer-events:none;";var f=document.createElement("div");
f.style.cssText="position:relative; left:15px; top:-28px; width:8px; height:8px; pointer-events:none; background-color: "+this.colorSelect+";  border-radius:20px;";e.innerHTML=a.substr(0,a.lastIndexOf("."));c.appendChild(d);c.appendChild(e);c.appendChild(f);this.zone.appendChild(c);c.name=b;c.onclick=function(a){this.openFile(a)}.bind(this);c.ondblclick=function(a){this.openFile(a)}.bind(this);c.onmouseover=function(a){this.iconOver(a)}.bind(this);c.onmouseout=function(a){this.unselected(a)}.bind(this);
c.onmouseup=function(a){this.unselected(a)}.bind(this);c.ondragstart=function(a){this.dragstart(a)}.bind(this);c.ondragend=function(a){this.dragend(a)}.bind(this);this.icons[b]=c;this.files[b]=a},iconOver:function(a){a.target.className="ic icover";a.preventDefault();a=a.target.name;a!==this.currentFile&&(this.icons[a].childNodes[0].style.border="2px solid "+this.colorOver)},unselected:function(a){a.target.className="ic icout";a.preventDefault();a=a.target.name;a!==this.currentFile&&(this.icons[a].childNodes[0].style.border=
