...
self.onmessage = function (e) {
	...
	if(m==='run'){
	    ...
	    self.postMessage({ w:world.isWorld, fps:f[3], ar:ar, dr:dr },[ar.buffer]);
	}
}
    ...
    init:function(){
		if(this.world == null){
			...
			switch(this.Broadphase){
				case 'SAP': this.broadphase = new Ammo.btAxisSweep3(AMMO.V3(-10*this.ws,-10*this.ws,-10*this.ws),AMMO.V3(10*this.ws,10*this.ws,10*this.ws), 4096); break;//16384;
