...
3]),"BLOB"!==a.type&&a[b].quaternion.set(this.ar[c+4],this.ar[c+5],this.ar[c+6],this.ar[c+7]));a=this.root.cars;for(var b=a.length,d=4,e,f;b--;)for(c=40*b,this.dr[c]&&(a[b].position.set(this.dr[c+5],this.dr[c+6],this.dr[c+7]),a[b].quaternion.set(this.dr[c+1],this.dr[c+2],this.dr[c+3],this.dr[c+4]));d--;)f=8*(d+1),e=this.root.wheels[d],e.position.set(this.dr[c+f+5],this.dr[c+f+6],this.dr[c+f+7]),e.quaternion.set(this.dr[c+f+1],this.dr[c+f+2],this.dr[c+f+3],this.dr[c+f+4]);this.computeTime()}},postAmmo:function(){this.w.postMessage({m:"run",
m2:this.msg,key:this.root.nav.key,ar:this.ar,dr:this.dr},[this.ar.buffer,this.dr.buffer])},upOimo:function(a){if(a.data.init)this.postMess();else{a.data.w&&!this.isReady&&(this.isReady=!0);this.fps=a.data.fps;this.ar=a.data.ar;a=this.root.meshs;for(var b=a.length,c;b--;)c=8*b,this.ar[c]&&(a[b].position.set(this.ar[c+1],this.ar[c+2],this.ar[c+3]),"BLOB"!==a.type&&a[b].quaternion.set(this.ar[c+4],this.ar[c+5],this.ar[c+6],this.ar[c+7]));this.computeTime()}},postOimo:function(){this.w.postMessage({m:"run",
