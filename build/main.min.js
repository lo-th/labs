'use strict';var LTH={},useDirect=useDirect||!1;LTH.CODES="full serious rot terrain liquid ammo oimo crowd traffic".split(" ");LTH.rubriques=[];LTH.demoNames=[];LTH.libsNames=[];LTH.ARCS={};LTH.cRubr=-1;LTH.cFile=-1;LTH.ToRad=Math.PI/180;var esprima=esprima||{};esprima.parse=esprima.parse||{};var CodeMirror=CodeMirror||{},GRAD=GRAD||{},history,main;window.onload=init;function init(){main=new LTH.Main}function endTranscode(){main.menu.initHomeland(main.detector.webgl)}
LTH.Main=function(){this.detector={canvas:!!window.CanvasRenderingContext2D,webgl:function(){try{var a=document.createElement("canvas");return!(!window.WebGLRenderingContext||!a.getContext("webgl")&&!a.getContext("experimental-webgl"))}catch(b){return!1}}(),workers:!!window.Worker,fileapi:window.File&&window.FileReader&&window.FileList&&window.Blob};this.useDirect=useDirect;this.menuSize=60;this.doc=document;this.mainClass=this.doc.body.className="night";this.doc.body.ondragover=function(a){return!1};
this.day=!1;this.mode="basic";this.items=[];this.showCode=!1;this.viewType="vertical";this.scriptText=14;this.isFirst=!1;this.previewMain=this.previewDoc=this.preview=this.editorFragment=this.editorVertex=this.editor=this.menu=this.transcode=null;this.happ=this.supports_history_api();this.fileSystem=new LTH.FileSystem(this);this.fileSystem.loadXML("menu.xml")};
