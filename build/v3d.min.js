...
"../../js/libs/oimo.min.js",d=1E3,f=e=10,g=0,l=8,h=3,this.update=this.upOimo,this.postMess=this.postOimo}window.top.main.transcode.useTrans&&(k=window.top.main.transcode.codes[this.name]);this.w=new Worker(c);this.w.postMessage=this.w.webkitPostMessage||this.w.postMessage;this.w.onmessage=function(a){this.update(a)}.bind(this);this.ar=new V.AR32(d*l);this.dr=new V.AR32(e*h);this.pr=new V.AR32(g*h);this.drn=new V.AR32(f);this.drc=new V.AR32(f);this.prn=new V.AR32(f);this.d=[16.667,0,0];this.isReady=
!1;this.fps=0;this.w.postMessage({m:"init",url:k})};
