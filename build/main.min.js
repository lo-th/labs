...
LTH.FileSystem.prototype={constructor:LTH.FileSystem,loadXML:function(a){var b=new XMLHttpRequest;b.onload=function(a){a=b.responseXML.getElementsByTagName("rubrique");for(var e,d,f,g,h,l,k=0;k<a.length;k++)for(e=a[k],"n"===e.attributes[1].name?(d=e.attributes[1].value,f=e.attributes[0].value):(d=e.attributes[0].value,f=e.attributes[1].value),LTH.rubriques[k]=d,LTH.ARCS[LTH.rubriques[k]]={color:"#"+f,demos:[],icon:[]},LTH.demoNames[k]=[],LTH.libsNames[k]=[],e=e.getElementsByTagName("demo"),d=0;d<
e.length;d++){for(f=e[d].attributes.length;f--;)"n"===e[d].attributes[f].name&&(g=e[d].attributes[f].value),"lib"===e[d].attributes[f].name&&(h=e[d].attributes[f].value),"ic"===e[d].attributes[f].name&&(l=e[d].attributes[f].value);LTH.demoNames[k][d]=g;LTH.ARCS[LTH.rubriques[k]].demos[d]=g;LTH.ARCS[LTH.rubriques[k]].icon[d]=1*l;LTH.libsNames[k][d]=h.split("|").map(function(a){return a})}this.main.init()}.bind(this);b.open("GET",a,!0);b.send()},load:function(a){a.substring(a.lastIndexOf(".")+1,a.length);
var b=a.substring(a.lastIndexOf("/")+1,a.lastIndexOf(".")),c=new XMLHttpRequest;c.onload=function(a){this.process(b,c.responseText)}.bind(this);c.open("GET",a,!0);c.send()},open:function(a){var b=a.name,c=new FileReader,e=this;c.onload=function(a){e.process(b,a.target.result)};c.readAsText(a.file)},save:function(){var a=new Blob([this.main.editor.get()],{type:"application/text/javascript;charset=utf-8"});this.main.createLink(a,this.main.editor.currentName+".js","application/text/javascript;charset=utf-8")},
...
e=0;e<d.length;e++){var f=d[e],g=document.createElement("div");g.className="esprima-error";g.textContent=f.message.replace(/Line [0-9]+: /,"");var h=f.lineNumber-1;c.errorLines.push(h);b.addLineClass(h,"background","errorLine");var l=b.addLineWidget(h,g);c.widgets.push(l)}}catch(k){g=document.createElement("div"),g.className="esprima-error",g.textContent=k.message.replace(/Line [0-9]+: /,""),h=k.lineNumber-1,c.errorLines.push(h),b.addLineClass(h,"background","errorLine"),l=b.addLineWidget(h,g),c.widgets.push(l)}return 0===
