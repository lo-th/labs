...
this.nav=new V.Nav(this,a,b,c);this.base=new THREE.Group;this.content=new THREE.Group;this.skinned=new THREE.Group;this.scene.add(this.base);this.scene.add(this.content);this.scene.add(this.skinned);this.initGeo();this.initMat();this.pool=new V.SeaPool;this.postEffect=null;this.deb="";this.f=[0,0,0,0];this.meshs=[];this.lines=[];this.anchors={};this.ps=[];this.model="skull";this.w=this.basic=null;this.isWithSerious=this.isW=!1;window.onresize=function(a){this.resize(a)}.bind(this)};
...
new V.Gui(a)},ssao:function(a){this.renderMode="ssao";this.postEffect=new V.PostEffect(this,"ssao",a)},metaball:function(a){this.renderMode="metaball";this.sceneBlob=new THREE.Scene;this.postEffect=new V.PostEffect(this,"metaball",!1,a)},deformSsao:function(a,b){this.postEffect.deformSsao(a,b)},resize:function(){this.dimentions.w=window.innerWidth;this.dimentions.h=window.innerHeight;this.dimentions.r=this.dimentions.w/this.dimentions.h;this.renderer.setSize(this.dimentions.w,this.dimentions.h);this.nav.camera.aspect=
this.dimentions.r;this.nav.camera.updateProjectionMatrix();null!==this.postEffect&&this.postEffect.isActive&&this.postEffect.resize(this.dimentions.w,this.dimentions.h)},colorBack:function(a){null!==this.postEffect&&this.renderer.setClearColor(a,1)},zone:function(){this.z=new THREE.Mesh(this.geo.ground,this.mat.zone);this.z.name="zone";this.z.scale.set(1,1,1);this.z.visible=!1;this.base.add(this.z)},addModel:function(a){null!==this.basic&&this.scene.remove(this.basic);"plane"===this.model?(this.basic=
new THREE.Mesh(this.geo.ground,a),this.basic.geometry.computeTangents(),this.basic.scale.set(50,50,50),this.scene.add(this.basic)):"sphere"===this.model?(this.basic=new THREE.Mesh(this.geo.sphereHigh,a),this.basic.scale.set(25,25,25),this.scene.add(this.basic)):(this.tmpmat=a,this.pool.load(this.model,this.onModelLoaded))},onModelLoaded:function(){var a=v.pool.meshes[v.model],b=new THREE.Geometry,c;for(c in a)b.merge(a[c].geometry);v.basic=new THREE.Mesh(V.TransGeo(b,!0),v.tmpmat);"skull"==v.model?
v.basic.scale.set(10,10,-10):"skullhigh"==v.model?v.basic.scale.set(2,2,-2):"head"==v.model?(v.basic.scale.set(8,8,-8),v.basic.position.y=-40):"woman"==v.model?(v.basic.scale.set(60,60,-60),v.basic.position.y=-37):v.basic.scale.set(1,1,-1);v.scene.add(v.basic)},basic:function(){this.basic=new THREE.Mesh(this.geo.ground,this.mat.base);this.basic.scale.set(50,50,50);this.scene.add(this.basic)},ground:function(){this.m=new THREE.Mesh(this.geo.ground,this.mat.base);this.m.scale.set(50,50,50);this.scene.add(this.m)},
tell:function(a){this.info.innerHTML=a},addBlob:function(a,b,c){a=new V.Blob(this,a,b);if(c)return a;this.meshs[this.meshs.length]=a},add:function(a){var b=new THREE.Mesh(this.geo[a.type||"box"],this.mat[a.mat||"base2"]);a.pos=a.pos||[0,0,0];a.size=a.size||[1,1,1];b.scale.set(a.size[0],a.size[1],a.size[2]);b.position.set(a.pos[0],a.pos[1],a.pos[2]);b.rotation.set(0,0,0);this.scene.add(b);this.meshs[this.meshs.length]=b;this.w&&this.w.add(a)},addParticle:function(a){var b=this.ps.length;this.ps[b]=
new V.Particle(this,a);a.id=b;this.w&&this.w.addParticle(a)},initGeo:function(){var a={};a.sphere=(new THREE.BufferGeometry).fromGeometry(new THREE.SphereGeometry(1,12,10));a.sphereHigh=(new THREE.BufferGeometry).fromGeometry(new THREE.SphereGeometry(1,34,28));a.box=(new THREE.BufferGeometry).fromGeometry(new THREE.BoxGeometry(1,1,1));a.cylinder=(new THREE.BufferGeometry).fromGeometry(new THREE.CylinderGeometry(1,1,1,12,1));a.plane=new THREE.PlaneBufferGeometry(1,1);a.ground=new THREE.PlaneBufferGeometry(1,
1);a.ground.applyMatrix((new THREE.Matrix4).makeRotationX(-V.PI90));this.geo=a},initMat:function(){var a={};a.none=new THREE.MeshBasicMaterial({transparent:!0,opacity:0,fog:!1,depthTest:!1,depthWrite:!1});a.zone=new THREE.MeshBasicMaterial({color:65280,transparent:!0,opacity:0.1,fog:!1,depthTest:!1,depthWrite:!1});a.base=new THREE.MeshBasicMaterial({color:0});a.anchor=new THREE.MeshBasicMaterial({color:16724736});a.Sanchor=new THREE.MeshBasicMaterial({color:16777215});a.base2=new THREE.MeshBasicMaterial({color:65280,
map:THREE.ImageUtils.loadTexture("images/grid1.jpg")});this.mat=a},addWorker:function(a,b){this.w=new V.Worker(this,a);this.wFun=b||function(){}},addRenderTarget:function(a,b){var c=new THREE.WebGLRenderTarget(a,b,{minFilter:THREE.LinearFilter,magFilter:THREE.LinearFilter,format:THREE.RGBAFormat});this.isWithSerious=!0;return c},chaine:function(a){for(var b=a.close||!1,c=this.lines.length,d=new THREE.LineBasicMaterial({color:16737809}),e=new THREE.Geometry,g=0.5*a.points.length,f,h=0;h<g;h++)f=2*
h,f=new THREE.Vector3(a.points[f],0,a.points[f+1]),e.vertices.push(f),this.addAnchor(f,c,h,b);a.close&&e.vertices.push(new THREE.Vector3(a.points[0],0,a.points[1]));b=new THREE.Line(e,d);this.scene.add(b);this.lines[c]=b;this.w&&this.w.chaine(a)},addAnchor:function(a,b,c,d){var e=new THREE.Mesh(this.geo.box,this.mat.anchor);e.position.copy(a);e.name=d?"ca"+b+"_"+c:"oa"+b+"_"+c;this.base.add(e);this.anchors[e.name]=e},upAnchor:function(a){var b=a.name,c=b.lastIndexOf("_"),d=b.substring(2,c)||0,d=1*
d,c=b.substring(c+1,b.length)||0,c=1*c,d=this.lines[d],e=d.geometry.vertices.length;d.geometry.vertices[c].copy(a.position);"c"==b.substring(0,1)&&0==c&&d.geometry.vertices[e-1].copy(a.position);d.geometry.verticesNeedUpdate=!0;this.w&&(this.w.dr[2*c]=a.position.x,this.w.dr[2*c+1]=a.position.z,this.w.msg="updecal")}};
V.Blob=function(a,b,c){THREE.Object3D.call(this);this.type="BLOB";this.root=a;a=this.root.geo.plane;var d=new THREE.MeshBasicMaterial({color:0});this.s1=new THREE.Mesh(a,d);c=2*(c||20);this.s1.scale.set(c,c,c);this.root.sceneBlob.add(this.s1);b&&this.position.copy(b)};V.Blob.prototype=Object.create(THREE.Object3D.prototype);V.Blob.prototype.constructor=V.Blob;V.Blob.prototype._updateMatrix=V.Blob.prototype.updateMatrix;
V.Blob.prototype.updateMatrix=function(){console.log("up");this._updateMatrix();null!=this.customMatrix&&this.matrix.multiply(this.customMatrix)};V.Blob.prototype.clear=function(){this.root.sceneBlob.remove(this.s1)};V.Blob.prototype.update=function(a){this.s1.position.copy(this.position);this.s1.rotation.copy(a)};
...
this.environment.needsUpdate=!0;for(var b=this.shaders.length;b--;)this.shaders[b].isActive&&(this.shaders[b].uniforms.env.value=this.environment)}.bind(this);a.src="images/spherical/"+this.envLists[this.nEnv]},add:function(a){this.shaders.push(a)}};V.Particle=function(a,b){this.root=a;this.mode=this.root.renderMode;this.radius=b.radius||0.25;if("metaball"==this.mode)this.rotation=this.root.nav.camera.rotation,this.particles=[];else{this.geometry=new THREE.Geometry;this.material=new THREE.PointCloudMaterial({size:4*this.radius,sizeAttenuation:!0,map:this.makeSprite(),transparent:!0});this.particles=new THREE.PointCloud(this.geometry,this.material);this.particles.sortParticles=!0;this.particles.dynamic=!0;for(var c=b.n||0;c--;)this.addV();this.root.scene.add(this.particles)}};
V.Particle.prototype={constructor:V.Particle,makeSprite:function(){var a=document.createElement("canvas");a.width=a.height=32;var b=a.getContext("2d"),c=0.5*a.width,d=0.5*a.height;b.beginPath();b.fillStyle="#FF0000";b.arc(c,d,16,0,2*Math.PI,!1);b.fill();a=new THREE.Texture(a);a.needsUpdate=!0;return a},getLength:function(){return"metaball"==this.mode?this.particles.length:this.particles.geometry.vertices.length},addNum:function(a){for(;a--;)this.addV();"metaball"!==this.mode&&this.update()},addV:function(a,
b,c){a=new THREE.Vector3(a||0,b||0,c||0);"metaball"==this.mode?this.particles.push(v.addBlob(a,4*this.radius,!0)):(this.particles.geometry.vertices.push(a),this.particles.geometry.dispose())},move:function(a,b,c,d){"metaball"==this.mode?(this.particles[a].position.set(b,c,d),this.particles[a].update(this.rotation)):this.geometry.vertices[a]&&(this.geometry.vertices[a].x=b||0,this.geometry.vertices[a].y=c||0,this.geometry.vertices[a].z=d||0)},update:function(){"metaball"!==this.mode&&(this.geometry.verticesNeedUpdate=
!0)}};V.Point=function(a,b,c,d,e,g){this.x=a||0;this.y=b||0;this.z=c||0;this.r=d||0;this.c=e||0;this.s=g||0};V.SeaPool=function(){this.meshes={}};V.SeaPool.prototype={constructor:V.SeaPool,load:function(a,b,c){this.callback=b||function(){};var d="",e=new THREE.SEA3D(!0);e.onComplete=function(b){this.meshes[a]={};b=e.meshes.length;for(var f;b--;)f=e.meshes[b],this.meshes[a][f.name]=f,d+=f.name+",";c&&console.log(d);this.callback()}.bind(this);e.parser=THREE.SEA3D.DEFAULT;e.load("models/"+a+".sea")}};
