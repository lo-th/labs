...
null;this.deb="";this.f=[0,0,0,0];this.meshs=[];this.cars=[];this.speeds=[];this.wheels=[];this.steering=[];this.lines=[];this.anchors={};this.ps=[];this.model="skull";this.w=this.groundMirror=this.basic=null;this.isWithSerious=this.isW=!1;this.material=new V.Material(this);window.onresize=function(a){this.resize(a)}.bind(this)};
