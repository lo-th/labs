...
!0;return c},chaine:function(a){for(var b=a.close||!1,c=this.lines.length,d=new THREE.LineBasicMaterial({color:16737809}),e=new THREE.Geometry,g=0.5*a.points.length,f,h=0;h<g;h++)f=2*h,f=new THREE.Vector3(a.points[f],0,a.points[f+1]),e.vertices.push(f),this.addAnchor(f,c,h,b);a.close&&e.vertices.push(new THREE.Vector3(a.points[0],0,a.points[1]));b=new THREE.Line(e,d);this.scene.add(b);this.lines[c]=b;this.w&&this.w.chaine(a)},addAnchor:function(a,b,c,d){var e=new THREE.Mesh(this.geo.box,this.mat.anchor);
...
V.ProjectUV=function(a,b){null===a.boundingBox&&a.computeBoundingBox();var c=a.boundingBox.max,d=a.boundingBox.min;b.uniforms.offset.value=new THREE.Vector2(0-d.x,0-d.z);b.uniforms.range.value=new THREE.Vector2(c.x-d.x,c.z-d.z)};V.TransGeo=function(a,b){a.mergeVertices();a.verticesNeedUpdate=!0;a.normalsNeedUpdate=!0;a.computeFaceNormals();a.computeVertexNormals(!0);a.computeTangents();if(b)return a;var c=(new THREE.BufferGeometry).fromGeometry(a);a.dispose();return c};V.PostEffect=function(a,b,c){this.root=a;this.name=b;this.init(c)};
...
V.Shader.prototype.loading=function(a){var b;window.XMLHttpRequest?b=new XMLHttpRequest:window.ActiveXObject&&(b=new ActiveXObject("Microsoft.XMLHTTP"));b.onload=function(a){a=eval(b.responseText);this.uniforms=a.uniforms;this.vertexShader=a.vs;this.fragmentShader=a.fs;this.needsUpdate=!0;for(var d in this.parameters)this.uniforms[d]&&(this.uniforms[d].value=this.parameters[d],console.log(d));this.callback()}.bind(this);b.open("GET","shaders/"+a+".js",!0);b.send()};V.Worker=function(a,b){this.name=b;this.root=a;this.msg="";var c,d,e,g,f,h,k;switch(this.name){case "liquid":c="./js/worker/liquid_worker.js";d=1E3;e=100;g=10;f=1E3;h=4;k=2;break;case "oimo":c="./js/worker/oimo_worker.js",d=1E3,g=e=10,f=0,h=8,k=3}this.ar=new V.AR32(d*h);this.dr=new V.AR32(e*k);this.pr=new V.AR32(f*k);this.drn=new V.AR8(g);this.drc=new V.AR8(g);this.prn=new V.AR8(g);this.w=new Worker(c);this.w.postMessage=this.w.webkitPostMessage||this.w.postMessage;this.d=[16.667,0,0];this.isReady=
