...
initPreview:function(){this.preview=this.doc.createElement("iframe");this.preview.className="preview";this.preview.src="about:blank";this.doc.body.appendChild(this.preview)},update:function(a){if(""!==a){this.clearPreview();this.initPreview();var b="<script src='src/Vue3d.js'>\x3c/script>",c="<script src='js/libs/three.js'>\x3c/script>";isMain&&(b="<script src='build/v3d.min.js'>\x3c/script>",c="<script src='js/libs/three.min.js'>\x3c/script>");for(var d="",g=LTH.option[LTH.cRubrique][LTH.cFile],
e=g.length;e--;)d+="<script src='js/libs/"+g[e]+".min.js'>\x3c/script>";a=["<!DOCTYPE html>\n<html lang='en'>\n<head>\n<title>prev</title>\n<meta charset='utf-8'>\n<link rel='stylesheet' href='css/consolas.css'>\n<link rel='stylesheet' href='css/basic.css'>",c,"<script src='js/libs/three.post.js'>\x3c/script>",d,b,"<script id='shader'>\x3c/script>","</head><body class='"+this.mainClass+"'>","<script>\nvar canvas = document.createElement('canvas'); document.body.appendChild( canvas );\nvar info = document.createElement('div'); document.body.appendChild( info ); info.className = 'info';\nvar debug = document.createElement('div'); document.body.appendChild( debug ); debug.className = 'debug';",
a,"\x3c/script>\n</body></html>"].join("\n");this.previewDoc=this.preview.contentDocument||this.preview.contentWindow.document;this.previewMain=this.preview.contentWindow;this.previewDoc.open("text/html","replace");this.previewDoc.write(a);this.previewDoc.close();this.preview.style.display="block";this.resize();var f=this;this.previewMain.onload=function(){f.previewTheme()};this.isFirst?this.isFirst=!1:this.menu.modified()}},checkCurrent:function(){for(var a=0;a<this.numLesson;a++)this.items[a].style.background=
this.items[a].name==this.currentLesson?"#881288":"#121212"},loadFile:function(a){this.isFirst=!0;this.fileSystem.load(a)},openFile:function(a){this.fileSystem.open(a)},createLink:function(a,b,c){this.menu.addIconLink(a,b,c)},callSave:function(){this.fileSystem.save()}};LTH.ShaderToy=function(a){this.main=a;this.retour=document.createElement("div");this.retour.innerHTML=".join('&#92;n')";this.shaderName="";this.shaderBase=null;this.uniformValues={};this.uniformColors={};this.isShaderReady=!1};
...
addFile:function(a){var b=this,c=new FileReader;c.onload=function(c){c=a.name;c.substr(c.lastIndexOf(".")+1,c.length);b.pushFile(c)};c.readAsDataURL(a)},pushFile:function(a){for(var b=this,c=this.files.length;c--;)if(a==this.files[c])return;var c=this.icons.length,d=document.createElement("div");d.className="ic";var g=document.createElement("div");g.style.cssText="position:relative; left:10px; top:5px; width:18px; height:18px; pointer-events:none; background-color: none; border:2px solid rgba(0,0,0,0);  border-radius:20px;";
var e=document.createElement("div");e.style.cssText="position:relative; left:30px; top:-12px; width:calc(100% - 40px); height:20px; pointer-events:none; text-align:right;";var f=document.createElement("div");f.style.cssText="position:relative; left:15px; top:-28px; width:8px; height:8px; pointer-events:none; background-color: "+this.colorSelect+";  border-radius:20px;";e.innerHTML=a.substr(0,a.lastIndexOf("."));d.appendChild(g);d.appendChild(e);d.appendChild(f);this.zone.appendChild(d);d.name=c;d.onclick=
