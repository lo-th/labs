...
V.View=function(a,b,c){this.renderMode="";window.top.main.previewTheme();this.dimentions={w:window.innerWidth,h:window.innerHeight,r:window.innerWidth/window.innerHeight};this.mem="";this.canvas=canvas;this.debug=debug;this.info=info;this.renderer=new THREE.WebGLRenderer({canvas:canvas,precision:"mediump",antialias:!0,alpha:!0,stencil:!1});this.renderer.setSize(this.dimentions.w,this.dimentions.h);this.renderer.setClearColor(0,0);this.renderer.autoClear=!1;this.clock=new THREE.Clock;this.z=null;this.zones=
[];this.scene=new THREE.Scene;this.sceneBlob=new THREE.Scene;this.nav=new V.Nav(this,a,b,c);this.base=new THREE.Group;this.content=new THREE.Group;this.skinned=new THREE.Group;this.scene.add(this.base);this.scene.add(this.content);this.scene.add(this.skinned);this.initGeo();this.initMat();this.pool=new V.SeaPool;this.postEffect=null;this.deb="";this.f=[0,0,0,0];this.meshs=[];this.lines=[];this.anchors={};this.ps=[];this.model="skull";this.w=this.basic=null;this.isWithSerious=this.isW=!1;window.onresize=
function(a){this.resize(a)}.bind(this)};
