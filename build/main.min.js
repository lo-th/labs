...
",","vs: ["+a+"]"+this.retour.innerHTML,"}"].join("\n"),b=this.main.previewDoc.body,c=this.main.previewDoc.createElement("script");c.setAttribute("id","shader");c.type="text/javascript";c.charset="utf-8";c.text=a;b.appendChild(c);this.main.preview.contentWindow.shader.dispose();this.main.preview.contentWindow.shader.apply(this.main.previewMain.V[this.shaderName])}},pushUniform:function(a){var b=a.split(String.fromCharCode(32));a=b[1];var b=b[2].replace(";",""),c=this.isAlphanumeric(b),d=!1,g=null,
e=null,f;for(f in this.uniformValues)f===b&&(e=JSON.parse(this.uniformValues[f]));for(f in this.uniformColors)f===b&&(e=JSON.parse(this.uniformColors[f]),d=!0);f="";switch(a){case "sampler2D":case "samplerCube":f="t";break;case "vec2":f="v2";null!==e&&(g="new THREE.Vector2("+e.x+","+e.y+")");break;case "vec3":d?(f="c",null!==e&&(g="new THREE.Color("+e.r+","+e.g+","+e.b+")")):(f="v3",null!==e&&(g="new THREE.Vector3("+e.x+","+e.y+","+e.z+")"));break;case "vec4":f="v4";null!==e&&(g="new THREE.Vector3("+
e.x+","+e.y+","+e.z+","+e.w+")");break;case "int":f="i";null!==e&&(g=e);break;case "float":f="f";null!==e&&(g=e);break;case "mat4":f="m4"}c||(f+="v");this.uniform+=b+" : { type: '"+f+"', value: "+g+" },\n"},isAlphanumeric:function(a){return/^[0-9a-zA-Z]+$/.test(a)},getShader:function(a){for(var b="",c=a.lineCount(),d,g=0;g<c;g++)d=a.getLine(g),void 0!==d&&("uniform"===d.substring(0,7)&&this.pushUniform(d),b=0==g?b+("\n'"+d+"',\n"):g==c-1?b+("'"+d+"'\n"):b+("'"+d+"',\n"));return b}};
