...
update:function(a){if(""!==a){this.clearPreview();this.initPreview();var b,c,d;if(this.transcode.useTrans){b="";c=LTH.libsNames[LTH.cRubr][LTH.cFile];for(d=c.length;d--;)""!==c[d]&&(b+="<script src='"+this.transcode.codes[c[d]]+"'>\x3c/script>");a=["<!DOCTYPE html>\n<html lang='en'><head>\n<title>prev</title>\n<meta charset='utf-8'>\n<link rel='stylesheet' href='css/consolas.css'>\n<link rel='stylesheet' href='css/basic.css'>","<script src='"+this.transcode.codes.full+"'>\x3c/script>",b,"<script src='build/v3d.min.js'>\x3c/script>",
...
!0;this.fileSystem.load(a)},openFile:function(a){this.fileSystem.open(a)},createLink:function(a,b,c){this.menu.addIconLink(a,b,c)},callSave:function(){this.fileSystem.save()}};
...
break;case 3:c[1]="<path fill='#"+a+"' id='linkedin' d='M256.417,50c-113.771,0-206,92.229-206,206s92.229,206,206,206s206-92.229,206-206 S370.188,50,256.417,50z M201.456,355.592h-45.229V209.469h45.229V355.592z M178.626,190.333c-14.771,0-26.746-12.072-26.746-26.963 s11.975-26.963,26.746-26.963c14.77,0,26.745,12.072,26.745,26.963S193.396,190.333,178.626,190.333z M370.953,355.592h-45.01 c0,0,0-55.666,0-76.703s-7.991-32.781-24.626-32.781c-18.103,0-27.562,12.231-27.562,32.781c0,22.504,0,76.703,0,76.703h-43.38 V209.469h43.38v19.679c0,0,13.047-24.137,44.032-24.137c30.986,0,53.165,18.918,53.165,58.058 C370.953,302.209,370.953,355.592,370.953,355.592z'/></svg>"}return c.join("\n")};LTH.labsMenu=function(){this.baseColor="25292e";this.current=null;this.size=800;this.decal=1;this.rdecal=-30;this.center=0.5*this.size;this.radius=30;this.endRadius=110;this.line=0;this.content=document.createElement("div");document.body.appendChild(this.content);this.content.className="labsMenu";this.pins=[];this.angles=[];this.anglesEnd=[];this.anglesStart=[];this.colors=[];this.nDemos=[];this.rubNames=[];this.points=[];this.nRubriques=0;this.arcs=LTH.ARCS;this.init()};
LTH.labsMenu.prototype={constructor:LTH.labsMenu,init:function(){this.title=document.createElement("div");this.title.className="labsTitle";this.content.appendChild(this.title);this.subTitle=document.createElement("div");this.subTitle.className="labsSubTitle";this.content.appendChild(this.subTitle);this.canvas=document.createElement("canvas");this.canvas.className="labsCanvas";this.content.appendChild(this.canvas);this.pinsContent=document.createElement("div");this.pinsContent.className="pinsContent";
this.content.appendChild(this.pinsContent);this.ctx=this.canvas.getContext("2d");this.canvas.width=this.canvas.height=this.size;var a=0,b;for(b in this.arcs)this.rubNames[a]=b,a++;this.nRubriques=a;this.compute();this.content.onmousemove=function(a){this.mouseMove(a)}.bind(this);this.time=10;this.anim=setTimeout(function(a){this.update()}.bind(this),this.time);this.draw()},update:function(){this.radius++;this.line+=0.2;this.radius==this.endRadius?(clearTimeout(this.anim),this.draw(!0)):(this.draw(),
this.time-=0.2,this.anim=setTimeout(function(a){this.update()}.bind(this),this.time))},mouseMove:function(a){var b=a.clientX-0.5*window.innerWidth;a=a.clientY-0.5*window.innerHeight;var c=Math.atan2(b,-a),c=Math.round(180/Math.PI*c);0>c&&(c+=360);c+=this.rdecal;Math.round(Math.sqrt(b*b+a*a))>this.radius-50?(this.findRubrique(c),null!==this.current&&(this.title.style.background=this.arcs[this.current].color,this.title.innerHTML=this.current.replace("-"," ").toUpperCase())):(this.current=null,this.title.style.background=
"none",this.title.innerHTML="",this.subTitle.innerHTML="")},findRubrique:function(a){for(var b=this.nRubriques;b--;)a<this.anglesEnd[b]&&a>this.anglesStart[b]&&(this.current=this.rubNames[b])},compute:function(){var a=0,b,c=0,d=0,e;for(e in this.arcs)b=this.arcs[e],this.colors[a]=b.color,this.nDemos[a]=b.demos.length,d+=this.nDemos[a],a++;a=360/d;d=b=0;for(e in this.arcs){b=this.nDemos[c]*a;this.anglesStart[c]=d+this.decal+this.rdecal;this.anglesEnd[c]=d+b-this.decal+this.rdecal;var f=this.anglesStart[c]+
0.5*(this.anglesEnd[c]-this.anglesStart[c])-60;this.angles[c]=f;this.points[c]=this.findPoint(f);d+=b;c++}},findPoint:function(a){var b=a*LTH.ToRad,c=(a+13)*LTH.ToRad;a=(a-13)*LTH.ToRad;for(var d,e=90,f=this.endRadius,g=[],h=0;13>h;h++)0==h?d=this.radialPos(b,f+25):1==h?d=this.radialPos(b,f+70):1==(h&1)?(d=this.radialPos(a,f+e),e+=45):d=this.radialPos(c,f+e),g.push(d);return g},radialPos:function(a,b){return{x:Math.cos(a)*b+this.center,y:Math.sin(a)*b+this.center}},draw:function(a){this.ctx.clearRect(0,
0,this.size,this.size);for(var b=this.nRubriques;b--;)this.ctx.strokeStyle=this.colors[b],this.ctx.beginPath(),this.ctx.arc(this.center,this.center,this.radius,(this.anglesStart[b]-60)*LTH.ToRad,(this.anglesEnd[b]-60)*LTH.ToRad,!1),this.ctx.lineWidth=this.line,this.ctx.stroke();a&&this.placesPins()},placesPins:function(){this.prevPins=[];this.startPins=0;this.endPins=13;this.time=100;this.anim=setTimeout(function(a){this.updatePins()}.bind(this),this.time)},updatePins:function(){var a=this.nRubriques,
b,c,d;if(this.startPins==this.endPins)clearTimeout(this.anim);else{for(b=this.prevPins.length;b--;)this.prevPins[b].style.display="block";for(b=this.pins.length;b--;)this.pins[b].className="pins pinson",this.prevPins[b]=this.pins[b].childNodes[0];for(;a--;)b=this.points[a],c=this.nDemos[a],d=this.colors[a],this.startPins<c&&(this.liner(b,d,this.startPins),this.addPins(b[this.startPins+1].x,b[this.startPins+1].y,d,this.startPins,a));this.startPins++;this.anim=setTimeout(function(a){this.updatePins()}.bind(this),
this.time)}},liner:function(a,b,c){this.ctx.strokeStyle=b;this.ctx.beginPath();this.ctx.moveTo(a[0].x,a[0].y);0==c&&this.ctx.lineTo(a[1].x,a[1].y);1==c&&(this.ctx.moveTo(a[1].x,a[1].y),this.ctx.lineTo(a[2].x,a[2].y));2==c&&(this.ctx.moveTo(a[1].x,a[1].y),this.ctx.lineTo(a[3].x,a[3].y));3==c&&(this.ctx.moveTo(a[2].x,a[2].y),this.ctx.lineTo(a[4].x,a[4].y));4==c&&(this.ctx.moveTo(a[3].x,a[3].y),this.ctx.lineTo(a[5].x,a[5].y));5==c&&(this.ctx.moveTo(a[4].x,a[4].y),this.ctx.lineTo(a[6].x,a[6].y));6==c&&
(this.ctx.moveTo(a[5].x,a[5].y),this.ctx.lineTo(a[7].x,a[7].y));this.ctx.lineWidth=2;this.ctx.stroke()},addPins:function(a,b,c,d,e){var f=this.pins.length,g=document.createElement("div");g.className="pins";g.style.left=a+"px";g.style.top=b+"px";g.style.background=c;g.name=e+"_"+d;a=document.createElement("div");a.className="pinsin";a.innerHTML=LTH.IconMicro(this.baseColor,this.arcs[this.rubNames[e]].icon[d]);g.appendChild(a);this.pins[f]=g;this.pins[f].onmouseover=function(a){a.target.style.background=
"#d2cec8";var b=this.rubNames[a.target.name.substring(0,1)];a=a.target.name.substring(2,a.target.name.length);this.subTitle.innerHTML=this.arcs[b].demos[a].replace("_"," ").toUpperCase()}.bind(this);this.pins[f].onmouseout=function(a){a.target.style.background=c};this.pinsContent.appendChild(this.pins[f])}};
LTH.IconMicro=function(a,b){var c=["<svg version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' preserveAspectRatio='none' x='0px' y='0px' width='30px' height='30px' viewBox='0 0 30 30';'>"];switch(b){case 0:c[1]="<g id='Layer'><path fill='#"+a+"' d='M 26 16 L 26 14 22 14 22 10 20 8 16 8 16 4 14 4 14 8 10 8 8 10 8 14 4 14 4 16 8 16 8 20 10 22 14 22 14 26 16 26 16 22 20 22 22 20 22 16 26 16 M 19 10 L 20 11 20 19 19 20 11 20 10 19 10 11 11 10 19 10 Z'/><use xlink:href='#Layer'/></g></svg>";
break;case 1:c[1]="<g id='Layer'><path fill='#"+a+"' d='M 16 11 L 14 11 14 14 11 14 11 16 14 16 14 19 16 19 16 16 19 16 19 14 16 14 16 11 Z'/><use xlink:href='#Layer'/></g></svg>"}return c.join("\n")};LTH.logoTimer=null;
LTH.Menu=function(a){this.baseColor="d2cec8";this.baseColorOver="FF0073";this.main=a;this.doc=document;this.content=this.doc.createElement("div");this.content.className="menu";this.doc.body.appendChild(this.content);this.rubriques=[];this.icons=[];this.files=[];this.buttons=[];this.inModif=this.currentFile=-1;this.colorSelect="#d2cec8";this.colorModif="#FF0073";this.colorOver="rgba(255,255,255,0.3)";this.logo=this.zone=this.currentLink=null;this.isHome=this.isMenu=!1;this.leftMenu=this.home=null;
this.initLogo();var b=this;this.main.happ&&window.addEventListener("popstate",function(a){b.isHome?history.back():b.initHome(a)})};
LTH.Menu.prototype={constructor:LTH.Menu,initLogo:function(){this.logo=this.doc.createElement("div");this.logo.className="logo";this.content.appendChild(this.logo);this.logo.innerHTML=LTH.Logos(this.baseColor);this.title=this.doc.createElement("div");this.title.className="title";this.content.appendChild(this.title);this.title.innerHTML="WELCOME<br>LOADING CODES";this.miniLogos()},initHomeland:function(a){a?(this.initHome(),this.title.innerHTML="LOTH LABS",this.logo.onmousedown=function(a){this.initHome(a)}.bind(this),
this.logo.onmouseover=function(a){this.isHome||(this.title.innerHTML="BACK HOME")}.bind(this),this.logo.onmouseout=function(a){this.isHome||(this.title.innerHTML=LTH.rubriques[LTH.cRubr].toUpperCase())}.bind(this)):this.title.innerHTML="SORRY, YOU NEED<br>WEBGL BROWSER"},miniLogos:function(){this.micrologo=this.doc.createElement("div");this.micrologo.className="minilogoOut";this.content.appendChild(this.micrologo);this.iconsOut=[];for(var a=4;a--;){this.iconsOut[a]=this.doc.createElement("div");this.iconsOut[a].className=
"mmmlogo";this.iconsOut[a].name=a;var b=document.createElement("div");b.style.cssText="position:relative; left:0px; top:0px; width:36px; height:36px; pointer-events:none;";this.iconsOut[a].appendChild(b);b.innerHTML=LTH.IconMini(this.baseColor,a);this.iconsOut[a].onclick=function(a){this.openLink(a.target.name)}.bind(this);this.iconsOut[a].onmouseover=function(a){this.iconsOut[a.target.name].childNodes[0].innerHTML=LTH.IconMini(this.baseColorOver,a.target.name)}.bind(this);this.iconsOut[a].onmouseout=
function(a){this.iconsOut[a.target.name].childNodes[0].innerHTML=LTH.IconMini(this.baseColor,a.target.name)}.bind(this);this.micrologo.appendChild(this.iconsOut[a])}},redrawMini:function(){for(var a=4;a--;)this.iconsOut[a].childNodes[0].innerHTML=LTH.IconMini(this.baseColor,a)},openLink:function(a){var b;switch(a){case 0:b="https://twitter.com/3dflashlo";break;case 1:b="https://github.com/lo-th";break;case 2:b="https://plus.google.com/u/0/114170447432405103307";break;case 3:b="https://www.linkedin.com/pub/lo-th/27/202/b3/en";
break;case 4:b="https://www.facebook.com/laurent.thillet"}window.open(b,"_blank").focus()},stopBlink:function(){clearTimeout(LTH.logoTimer);this.logo.innerHTML=LTH.Logos(this.baseColor)},blinkOpen:function(a){a.logo.innerHTML=LTH.Logos(a.baseColor,!1);LTH.logoTimer=setTimeout(a.blinkClose,3E3,a)},blinkClose:function(a){a.logo.innerHTML=LTH.Logos(a.baseColor,!0);LTH.logoTimer=setTimeout(a.blinkOpen,150,a)},initHome:function(){this.doc.body.onmousemove=function(a){return!1};this.content.className="menu home";
this.blinkOpen(this);this.micrologo.style.display="block";this.main.shader.clear();this.isMenu&&this.resetMenu();if(!this.isHome){LTH.cRubr=-1;LTH.cFile=0;this.title.innerHTML="LOTH LABS";this.home=this.doc.createElement("div");this.home.style.cssText="position:absolute; left:10%; top:160px; width:80%; height:400px; text-align:center;";this.content.appendChild(this.home);for(var a,b=0;b<LTH.rubriques.length;b++)a=this.doc.createElement("div"),a.className="rub",a.name=b,a.innerHTML=LTH.rubriques[b].toUpperCase(),
a.onclick=function(a){this.resetHome(a)}.bind(this),a.onmouseover=function(a){a.target.className="rub rubover"},a.onmouseout=function(a){a.target.className="rub"},this.home.appendChild(a);this.isHome=!0}},resetHome:function(a){this.stopBlink();this.micrologo.style.display="none";LTH.cRubr=a.target.name;this.clearDiv(this.home);this.content.removeChild(this.home);this.isHome=!1;this.initMenu();this.main.happ&&history.pushState(null,null,"index.html");a.preventDefault()},resetMenu:function(){this.main.editor.clear();
"shader"===this.main.mode&&(this.main.editorVertex.clear(),this.main.editorFragment.clear());this.main.clearPreview();this.clearDiv(this.zone);this.clearDiv(this.leftMenu);this.content.removeChild(this.leftMenu);this.content.removeChild(this.zone);this.icons=[];this.files=[];this.buttons=[];this.isMenu=!1},initMenu:function(){this.doc.body.onmousemove=function(a){this.showHideMenu(a)}.bind(this);this.content.className="menu exemple";this.logo.className="logo lmin";var a="basic";"shaders"===LTH.rubriques[LTH.cRubr]&&
(a="shader");this.main.switchMode(a);this.main.resize();this.title.innerHTML="";this.initButton();this.initZone();for(var b=LTH.demoNames[LTH.cRubr],c=b.length,d=0;d<c;d++)a=b[d]+".js",this.pushFile(a);this.currentFile=this.main.startDemo||0;this.main.loadFile("demos/"+LTH.rubriques[LTH.cRubr]+"/"+this.files[this.currentFile]);this.resetIcon();this.isMenu=!0},clearDiv:function(a){for(;a.firstChild;)a.removeChild(a.firstChild)},initZone:function(){this.zone=this.doc.createElement("div");this.zone.className=
"zone";this.content.appendChild(this.zone);var a=this;this.zone.ondragover=function(b){a.zoneDragOver(b)};this.zone.ondragend=function(b){a.zoneDragEnd(b)};this.zone.ondrop=function(b){a.zoneDrop(b)}},initButton:function(){this.leftMenu=this.doc.createElement("div");this.leftMenu.className="bottomLeftMenu";this.content.appendChild(this.leftMenu);for(var a,b=0;5>b;b++)a=this.doc.createElement("div"),a.className="b",1<b&&(a.style.display="none"),this.leftMenu.appendChild(a),this.buttons[b]=a;this.buttons[0].innerHTML=
