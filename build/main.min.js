'use strict';var LTH={rubriques:"physics-2d physics-3d games shaders experiments others".split(" "),option:{"physics-2d":[[],[],[]],"physics-3d":[[],[]],games:[["sea3d","dat.gui"],["sea3d","dat.gui","rot","tween"],["sea3d","tween"]],shaders:[["sea3d","dat.gui"],["sea3d","dat.gui"],["sea3d","dat.gui"],["sea3d","dat.gui"],["sea3d","dat.gui"]],experiments:[["serious"]],others:[["dat.gui"],[]]},cRubrique:"",cFile:0},esprima=esprima||{};esprima.parse=esprima.parse||{};
var CodeMirror=CodeMirror||{},GRAD=GRAD||{},history,main;window.onload=init;function init(){main=new LTH.Main}
function showHideMenu(a){var b=main.menu.content.className;a=a.clientX;170<a&&"menu exemple In"===b&&(main.menu.content.className="menu exemple Out",main.menu.logo.className="logo lmin",main.menu.title.innerHTML="");60>a&&("menu exemple"===b||"menu exemple Out"===b)&&(main.menu.content.className="menu exemple In",main.menu.logo.className="logo lmax",main.menu.title.innerHTML=LTH.cRubrique.toUpperCase())}
LTH.Main=function(){this.menuSize=60;this.doc=document;this.mainClass=this.doc.body.className="night";this.doc.body.ondragover=function(a){return!1};this.doc.body.onmousemove=showHideMenu;this.day=!1;this.mode="basic";this.startDemo=0;this.numLesson=4;this.items=[];this.showCode=!1;this.viewType="vertical";this.scriptText=14;this.currentLesson=-1;this.isFirst=!1;this.previewMain=this.previewDoc=this.preview=this.editorFragment=this.editorVertex=this.editor=this.menu=null;this.happ=this.supports_history_api();
this.init()};
...
this.preview.contentWindow.document;this.previewMain=this.preview.contentWindow;this.previewDoc.open("text/html","replace");this.previewDoc.write(a);this.previewDoc.close();this.resize();this.previewMain.onload=function(){this.previewTheme()}.bind(this);this.isFirst?this.isFirst=!1:this.menu.modified()}},checkCurrent:function(){for(var a=0;a<this.numLesson;a++)this.items[a].style.background=this.items[a].name==this.currentLesson?"#881288":"#121212"},loadFile:function(a){this.isFirst=!0;this.fileSystem.load(a)},
openFile:function(a){this.fileSystem.open(a)},createLink:function(a,b,c){this.menu.addIconLink(a,b,c)},callSave:function(){this.fileSystem.save()}};LTH.ShaderToy=function(a){this.main=a;this.retour=document.createElement("div");this.retour.innerHTML=".join('&#92;n')";this.shaderName="";this.shaderBase=null;this.uniformValues={};this.uniformColors={};this.isShaderReady=!1};
LTH.ShaderToy.prototype={constructor:LTH.ShaderToy,open:function(a){this.main.fileSystem.load("shaders/"+a+".js",!0)},clear:function(){this.shaderName="";this.shaderBase=null;this.uniformColors={};this.uniformValues={};this.isShaderReady=!1},deCompacte:function(a,b){if("shader"===this.main.mode){this.uniformColors={};this.uniformValues={};var c=this.main.previewDoc.body,d=this.main.previewDoc.createElement("script");d.setAttribute("id","shader");d.type="text/javascript";d.charset="utf-8";d.text=b;
c.appendChild(d);try{this.shaderBase=this.main.previewMain.V[a],this.shaderName=a}catch(f){}finally{this.getUniformValue(this.shaderBase.uniforms),this.main.editorVertex.set(this.shaderBase.vs,!0),this.main.editorFragment.set(this.shaderBase.fs,!0),this.main.preview.contentWindow.shader.apply(this.shaderBase),this.isShaderReady=!0}}},getUniformValue:function(a){this.uniformValues={};for(var b in a){var c=a[b].type,d=JSON.stringify(a[b].value);"c"===c?this.uniformColors[b]=d:this.uniformValues[b]=
...
e=null,g;for(g in this.uniformValues)g===b&&(e=JSON.parse(this.uniformValues[g]));for(g in this.uniformColors)g===b&&(e=JSON.parse(this.uniformColors[g]),d=!0);g="";switch(a){case "sampler2D":case "samplerCube":g="t";break;case "vec2":g="v2";null!==e&&(f="new THREE.Vector2("+e.x+","+e.y+")");break;case "vec3":d?(g="c",null!==e&&(f="new THREE.Color("+e.r+","+e.g+","+e.b+")")):(g="v3",null!==e&&(f="new THREE.Vector3("+e.x+","+e.y+","+e.z+")"));break;case "vec4":g="v4";null!==e&&(f="new THREE.Vector3("+
e.x+","+e.y+","+e.z+","+e.w+")");break;case "int":g="i";null!==e&&(f=e);break;case "float":g="f";null!==e&&(f=e);break;case "mat4":g="m4"}c||(g+="v");this.uniform+=b+" : { type: '"+g+"', value: "+f+" },\n"},isAlphanumeric:function(a){return/^[0-9a-zA-Z]+$/.test(a)},getShader:function(a){for(var b="",c=a.lineCount(),d,f=0;f<c;f++)d=a.getLine(f),void 0!==d&&("uniform"===d.substring(0,7)&&this.pushUniform(d),b=0==f?b+("\n'"+d+"',\n"):f==c-1?b+("'"+d+"'\n"):b+("'"+d+"',\n"));return b}};
...
this.logo.onmouseout=function(a){this.isHome||(this.title.innerHTML=LTH.cRubrique.toUpperCase())}.bind(this)},initHome:function(){this.content.className="menu home";this.main.shader.clear();this.isMenu&&this.resetMenu();if(!this.isHome){LTH.cRubrique="";LTH.cFile=0;this.title.innerHTML="LOTH LABS";this.home=this.doc.createElement("div");this.home.style.cssText="position:absolute; left:10%; top:160px; width:80%; height:400px; text-align:center;";this.content.appendChild(this.home);for(var a,b=0;b<
LTH.rubriques.length;b++)a=this.doc.createElement("div"),a.className="rub",a.name=LTH.rubriques[b],a.innerHTML=LTH.rubriques[b].toUpperCase(),a.onclick=function(a){this.resetHome(a)}.bind(this),a.onmouseover=function(a){a.target.className="rub rubover"},a.onmouseout=function(a){a.target.className="rub"},this.home.appendChild(a);this.isHome=!0}},resetHome:function(a){LTH.cRubrique=a.target.name;this.clearDiv(this.home);this.content.removeChild(this.home);this.isHome=!1;this.initMenu();this.main.happ&&
history.pushState(null,null,"index.html");a.preventDefault()},resetMenu:function(){this.main.editor.clear();"shader"===this.main.mode&&(this.main.editorVertex.clear(),this.main.editorFragment.clear());this.main.clearPreview();this.clearDiv(this.zone);this.clearDiv(this.leftMenu);this.content.removeChild(this.leftMenu);this.content.removeChild(this.zone);this.icons=[];this.files=[];this.buttons=[];this.isMenu=!1},initMenu:function(){this.content.className="menu exemple";this.logo.className="logo lmin";
var a="basic";"shaders"===LTH.cRubrique&&(a="shader");this.main.switchMode(a);this.main.resize();this.title.innerHTML="";this.initButton();this.initZone();for(var b=0;b<LTH.option[LTH.cRubrique].length;b++)a="demo_"+b+".js",this.pushFile(a);this.currentFile=this.main.startDemo||0;this.main.loadFile("demos/"+LTH.cRubrique+"/"+this.files[this.currentFile]);this.resetIcon();this.isMenu=!0},clearDiv:function(a){for(;a.firstChild;)a.removeChild(a.firstChild)},initZone:function(){this.zone=this.doc.createElement("div");
