...
this.nav.camera.updateProjectionMatrix();null!==this.postEffect&&this.postEffect.isActive&&this.postEffect.resize(this.dimentions.w,this.dimentions.h)},colorBack:function(a){null!==this.postEffect&&this.renderer.setClearColor(a,1)},zone:function(){this.z=new THREE.Mesh(this.geo.ground,this.mat.zone);this.z.name="zone";this.z.scale.set(1,1,1);this.z.visible=!1;this.base.add(this.z)},addModel:function(a){null!==this.basic&&this.scene.remove(this.basic);"plane"===this.model?(this.basic=new THREE.Mesh(this.geo.ground,
a),this.basic.geometry.computeTangents(),this.basic.scale.set(50,50,50),this.scene.add(this.basic)):"sphere"===this.model?(this.basic=new THREE.Mesh(this.geo.sphereHigh,a),this.basic.scale.set(25,25,25),this.scene.add(this.basic)):(this.tmpmat=a,this.pool.load(this.model,this.onModelLoaded))},onModelLoaded:function(){var a=v.pool.meshes[v.model],b=new THREE.Geometry,c;for(c in a)b.merge(a[c].geometry);v.basic=new THREE.Mesh(V.TransGeo(b,!0),v.tmpmat);"skull"==v.model?v.basic.scale.set(10,10,-10):
"skullhigh"==v.model?v.basic.scale.set(2,2,-2):"head"==v.model?(v.basic.scale.set(8,8,-8),v.basic.position.y=-40):"woman"==v.model?(v.basic.scale.set(60,60,-60),v.basic.position.y=-37):v.basic.scale.set(1,1,-1);v.scene.add(v.basic)},basic:function(){this.basic=new THREE.Mesh(this.geo.ground,this.mat.base);this.basic.scale.set(50,50,50);this.scene.add(this.basic)},ground:function(){this.m=new THREE.Mesh(this.geo.ground,this.mat.base);this.m.scale.set(50,50,50);this.scene.add(this.m)},tell:function(a){this.info.innerHTML=
...
1,1];"blob"==a.type?(b=new THREE.Vector3(a.pos[0],a.pos[1],a.pos[2]),b=new V.Blob(this,b,4*a.size[0]),this.sceneBlob.add(b)):(b=new THREE.Mesh(this.geo[a.type||"box"],this.mat[a.mat||"base2"]),b.scale.set(a.size[0],a.size[1],a.size[2]),b.position.set(a.pos[0],a.pos[1],a.pos[2]),b.rotation.set(0,0,0),this.scene.add(b));this.meshs[this.meshs.length]=b;this.w&&this.w.add(a)},addParticle:function(a){var b=this.ps.length;this.ps[b]=new V.Particle(this,a);a.id=b;this.w&&this.w.addParticle(a)},initGeo:function(){var a=
