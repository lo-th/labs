...
b,c){this.menu.addIconLink(a,b,c)},callSave:function(){this.fileSystem.save()}};LTH.ShaderToy=function(a){this.main=a;this.retour=document.createElement("div");this.retour.innerHTML=".join('&#92;n')";this.shaderName="";this.shaderBase=null;this.uniformValues={};this.uniformColors={};this.isShaderReady=!1};
