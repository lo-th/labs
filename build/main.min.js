...
this.addPins(b[this.startPins+1].x,b[this.startPins+1].y,d,this.startPins,a));this.startPins++;this.anim=setTimeout(function(a){this.updatePins()}.bind(this),this.time)}},liner:function(a,b,c){this.ctx.strokeStyle=b;this.ctx.beginPath();this.ctx.moveTo(a[0].x,a[0].y);0==c&&this.ctx.lineTo(a[1].x,a[1].y);1==c&&(this.ctx.moveTo(a[1].x,a[1].y),this.ctx.lineTo(a[2].x,a[2].y));2==c&&(this.ctx.moveTo(a[1].x,a[1].y),this.ctx.lineTo(a[3].x,a[3].y));3==c&&(this.ctx.moveTo(a[2].x,a[2].y),this.ctx.lineTo(a[4].x,
a[4].y));4==c&&(this.ctx.moveTo(a[3].x,a[3].y),this.ctx.lineTo(a[5].x,a[5].y));5==c&&(this.ctx.moveTo(a[4].x,a[4].y),this.ctx.lineTo(a[6].x,a[6].y));6==c&&(this.ctx.moveTo(a[5].x,a[5].y),this.ctx.lineTo(a[7].x,a[7].y));this.ctx.lineWidth=2;this.ctx.stroke()},addPins:function(a,b,c,d,e){var f=this.pins.length,g=document.createElement("div");g.className="pins";g.style.left=a+"px";g.style.top=b+"px";g.style.background=c;g.name=e+"_"+d;a=document.createElement("div");a.className="pinsin";a.innerHTML=
