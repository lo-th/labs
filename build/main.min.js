'use strict';var LTH={rubriques:"physics-2d physics-3d games shaders experiments others".split(" "),option:{"physics-2d":[[],[],[]],"physics-3d":[[],[]],games:[["sea3d","dat.gui"],["sea3d","dat.gui","rot","tween"]],shaders:[["dat.gui"],["dat.gui"]],experiments:[["serious"]],others:[[]]},cRubrique:"",cFile:0},esprima=esprima||{},CodeMirror=CodeMirror||{},GRAD=GRAD||{},history,main;window.onload=init;function init(){main=new LTH.Main}
...
this.codeLoaded&&this.previewTheme()},previewTheme:function(){this.previewDoc.body.className=this.day?"day":"night";this.previewMain&&(this.day?this.previewMain.v.colorBack(13815496):this.previewMain.v.colorBack(2435374))},previewClearFocus:function(){for(var a=this.previewDoc.getElementsByTagName("*"),b=0,c;c=a[b++];)c.id&&c.blur()},clearPreview:function(){null!==this.preview&&(this.doc.body.removeChild(this.preview),this.preview=null,console.clear())},initPreview:function(){null==this.preview&&
(this.preview=this.doc.createElement("iframe"),this.preview.className="preview",this.doc.body.appendChild(this.preview));this.resize();this.previewDoc=this.preview.contentDocument||this.preview.contentWindow.document;for(var a="",b=LTH.option[LTH.cRubrique][LTH.cFile],c=b.length;c--;)a+="<script src='./js/libs/"+b[c]+".min.js'>\x3c/script>";a=["<!DOCTYPE html>\n<html lang='en'>\n<head>\n<title>prev</title>\n<meta charset='utf-8'>\n<link rel='stylesheet' href='./css/consolas.css'>\n<link rel='stylesheet' href='./css/basic.css'>\n<script src='./js/libs/three.min.js'>\x3c/script>\n<script src='./js/libs/three.post.js'>\x3c/script>",
a,"<script src='./src/Vue3d.js'>\x3c/script>\n<script id='shader'>\x3c/script>\n</head><body>\n<script> var main = null; var canvas = document.createElement('canvas'); document.body.appendChild( canvas );\x3c/script>\n</body></html>"].join("\n");this.preview.src="about:blank";this.previewDoc=this.preview.contentDocument||this.preview.contentWindow.document;this.previewDoc.open("text/html","replace");this.previewDoc.write(a);this.previewDoc.close()},update:function(a,b){if(b&&""!==a){null!==this.preview&&
this.clearPreview();this.initPreview();var c=this;this.preview.onload=function(b){c.previewTheme();c.previewMain=c.preview.contentWindow;"shader"===c.mode&&(c.previewMain.main=c);b=c.previewDoc.getElementsByTagName("head")[0];c.preview.style.display="block";var e=c.previewDoc.createElement("script");e.setAttribute("id","base");e.type="text/javascript";e.charset="utf-8";e.text=a;b.appendChild(e);c.codeLoaded=!0;c.previewTheme();c.isFirst?c.isFirst=!1:c.showModif()}}},checkCurrent:function(){for(var a=
0;a<this.numLesson;a++)this.items[a].style.background=this.items[a].name==this.currentLesson?"#881288":"#121212"},loadFile:function(a){this.isFirst=!0;this.fileSystem.load(a)},openFile:function(a){this.fileSystem.open(a)},createLink:function(a,b,c){this.menu.addIconLink(a,b,c)},showModif:function(){this.menu.modified()},callSave:function(){this.fileSystem.save()}};
LTH.ShaderToy=function(a){this.main=a;this.retour=document.createElement("div");this.retour.innerHTML=".join('&#92;n')";this.shaderName="";this.shaderBase=null;this.uniformValues={};this.uniformColors={};this.isShaderReady=!1};
...
b;c.appendChild(d);try{this.shaderBase=this.main.previewMain.V[a],this.shaderName=a}catch(e){}finally{this.getUniformValue(this.shaderBase.uniforms),this.main.editorVertex.set(this.shaderBase.vs,!0),this.main.editorFragment.set(this.shaderBase.fs,!0),this.main.preview.contentWindow.shad.apply(this.shaderBase),this.isShaderReady=!0}}},getUniformValue:function(a){this.uniformValues={};for(var b in a){var c=JSON.stringify(a[b].value);console.log(b,c);"c"===a[b].type?this.uniformColors[b]=c:this.uniformValues[b]=
c}},compacte:function(){if("shader"===this.main.mode&&this.isShaderReady){this.uniform="";var a=this.getShader(this.main.editorVertex.editor),b=this.getShader(this.main.editorFragment.editor),a=["V."+this.shaderName+"={","uniforms:{",this.uniform,"},","fs: ["+b+"]"+this.retour.innerHTML+",","vs: ["+a+"]"+this.retour.innerHTML,"}"].join("\n"),b=this.main.previewDoc.body,c=this.main.previewDoc.createElement("script");c.setAttribute("id","shader");c.type="text/javascript";c.charset="utf-8";c.text=a;
b.appendChild(c);this.main.preview.contentWindow.shad.dispose();this.main.preview.contentWindow.shad.apply(this.main.previewMain.V[this.shaderName])}},pushUniform:function(a){var b=a.split(String.fromCharCode(32));a=b[1];var b=b[2].replace(";",""),c=this.isAlphanumeric(b),d=!1,e=null,f=null,g;for(g in this.uniformValues)g===b&&(f=JSON.parse(this.uniformValues[g]));for(g in this.uniformColors)g===b&&(f=JSON.parse(this.uniformColors[g]),d=!0);g="";switch(a){case "sampler2D":case "samplerCube":g="t";
break;case "vec2":g="v2";null!==f&&(e="new THREE.Vector2("+f.x+","+f.y+")");break;case "vec3":d?(g="c",null!==f&&(e="new THREE.Color("+f.r+","+f.g+","+f.b+")")):(g="v3",null!==f&&(e="new THREE.Vector3("+f.x+","+f.y+","+f.z+")"));break;case "vec4":g="v4";null!==f&&(e="new THREE.Vector3("+f.x+","+f.y+","+f.z+","+f.w+")");break;case "int":g="i";null!==f&&(e=f);break;case "float":g="f";null!==f&&(e=f);break;case "mat4":g="m4"}c||(g+="v");this.uniform+=b+" : { type: '"+g+"', value: "+e+" },\n"},isAlphanumeric:function(a){return/^[0-9a-zA-Z]+$/.test(a)},
getShader:function(a){for(var b="",c=a.lineCount(),d,e=0;e<c;e++)d=a.getLine(e),void 0!==d&&("uniform"===d.substring(0,7)&&this.pushUniform(d),b=0==e?b+("\n'"+d+"',\n"):e==c-1?b+("'"+d+"'\n"):b+("'"+d+"',\n"));return b}};
