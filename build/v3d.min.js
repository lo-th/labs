...
V.Nav=function(a,b,c,d){this.isRevers=!1;this.cammode="normal";this.EPS=1E-6;this.root=a;this.cursor=new V.Cursor;this.lockView=!1;this.camera=new THREE.PerspectiveCamera(V.Resolution.f,this.root.dimentions.r,0.1,1E3);this.mouse3d=new THREE.Vector3;this.selectName="";this.rayVector=new THREE.Vector3(0,0,1);this.raycaster=new THREE.Raycaster;this.target=new THREE.Vector3;this.position=new THREE.Vector3;this.cam={horizontal:b||0,vertical:c||90,distance:d||20,automove:!1};this.mouse={x:0,y:0,ox:0,oy:0,
h:0,v:0,mx:0,my:0,down:!1,move:!0,button:0};this.key={up:0,down:0,left:0,right:0,ctrl:0,action:0,space:0,shift:0};this.moveCamera();this.root.canvas.oncontextmenu=function(a){a.preventDefault()};this.root.canvas.onclick=function(a){this.onMouseClick(a)}.bind(this);this.root.canvas.onmousemove=function(a){this.onMouseMove(a)}.bind(this);this.root.canvas.onmousedown=function(a){this.onMouseDown(a)}.bind(this);this.root.canvas.onmouseout=function(a){this.onMouseUp(a)}.bind(this);this.root.canvas.onmouseup=
function(a){this.onMouseUp(a)}.bind(this);this.root.canvas.onmousewheel=function(a){this.onMouseWheel(a)}.bind(this);this.root.canvas.addEventListener("DOMMouseScroll",function(a){this.onMouseWheel(a)}.bind(this),!1)};
