...
this.doc.createElement("iframe");this.preview.style.cssText="position:absolute;  border:none; pointer-events:auto; background:none; z-index:0; display:none;";this.doc.body.appendChild(this.preview)},update:function(a){if(""!==a){this.codeLoaded=!1;this.clearPreview();this.initPreview();this.tmpcode=a;a="<script src='src/Vue3d.js'>\x3c/script>";var b="<script src='js/libs/three.js'>\x3c/script>";isMain&&(a="<script src='build/v3d.min.js'>\x3c/script>",b="<script src='js/libs/three.min.js'>\x3c/script>");
for(var c="",d=LTH.option[LTH.cRubrique][LTH.cFile],f=d.length;f--;)c+="<script src='js/libs/"+d[f]+".min.js'>\x3c/script>";["<!DOCTYPE html>\n<html lang='en'>\n<head>\n<title>prev</title>\n<meta charset='utf-8'>\n<link rel='stylesheet' href='css/consolas.css'>\n<link rel='stylesheet' href='css/basic.css'>",b,"<script src='js/libs/three.post.js'>\x3c/script>",c,a,"<script id='shader'>\x3c/script>\n</head><body>\n<script> var main = null; var canvas = document.createElement('canvas'); document.body.appendChild( canvas ); \x3c/script>\n</body></html>"].join("\n");
var e=this;this.preview.src="demo.html";this.preview.onload=function(a){e.frameLoaded()}}},frameLoaded:function(){this.previewDoc=this.preview.contentDocument||this.preview.contentWindow.document;this.previewMain=this.preview.contentWindow;console.log("loaded");"shader"===this.mode&&(this.previewMain.main=this);var a=this.previewDoc.getElementsByTagName("head")[0],b=this.previewDoc.createElement("script");b.name="topScript";b.id="topScript";b.type="text/javascript";b.charset="utf-8";b.text=this.tmpcode;
...
var e=document.createElement("div");e.style.cssText="position:relative; left:30px; top:-12px; width:calc(100% - 40px); height:20px; pointer-events:none; text-align:right;";var g=document.createElement("div");g.style.cssText="position:relative; left:15px; top:-28px; width:8px; height:8px; pointer-events:none; background-color: "+this.colorSelect+";  border-radius:20px;";e.innerHTML=a.substr(0,a.lastIndexOf("."));d.appendChild(f);d.appendChild(e);d.appendChild(g);this.zone.appendChild(d);d.name=c;d.onclick=
