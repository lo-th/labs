...
V.Nav=function(a,b,c,d){this.isRevers=this.isFocus=!1;this.cammode="normal";this.EPS=1E-6;this.root=a;this.cursor=new V.Cursor;this.lockView=!1;this.camera=new THREE.PerspectiveCamera(V.Resolution.f,this.root.dimentions.r,0.1,1E3);this.mouse3d=new THREE.Vector3;this.selectName="";this.rayVector=new THREE.Vector3(0,0,1);this.raycaster=new THREE.Raycaster;this.target=new THREE.Vector3;this.position=new THREE.Vector3;this.cam={horizontal:b||0,vertical:c||90,distance:d||20,automove:!1,theta:0};this.mouse=
...
c||0,this.geometry.vertices[a].z=d||0)},update:function(){"metaball"!==this.mode&&(this.geometry.verticesNeedUpdate=!0)}};V.Point=function(a,b,c,d,e,f){this.x=a||0;this.y=b||0;this.z=c||0;this.r=d||0;this.c=e||0;this.s=f||0};V.SeaPool=function(a){this.root=a;this.meshes={};this.callback={}};
...
"../../js/libs/oimo.min.js";d=1E3;f=e=10;g=0;l=8;h=3;this.update=this.upOimo;this.postMess=this.postOimo;break;case "ammo":c="js/worker/ammo_worker.js";k="../../js/libs/ammo.min.js";d=1E3;e=20;f=10;g=0;l=8;h=40;this.update=this.upAmmo;this.postMess=this.postAmmo;break;case "traffic":c="js/worker/traffic_worker.js",k="../../js/libs/traffic.min.js",d=1E3,f=e=10,g=0,h=l=3,this.update=this.upTraffic,this.postMess=this.postTraffic}window.top.main.transcode.useTrans&&(k=window.top.main.transcode.codes[this.name]);
...
b.getLength()!==c&&b.addNum(c);for(d=c;d--;)c=2*d,b.move(d,this.pr[c],0,this.pr[c+1]);b.update()}this.computeTime()}},postLiquid:function(){this.w.postMessage({m:"run",prn:this.prn,ar:this.ar,pr:this.pr},[this.ar.buffer,this.pr.buffer])},upAmmo:function(a){if(a.data.init)this.postMess();else{a.data.w&&!this.isReady&&(this.isReady=!0);this.fps=a.data.fps;this.ar=a.data.ar;this.dr=a.data.dr;a=this.root.meshs;for(var b=a.length,c;b--;)c=8*b,this.ar[c]&&(a[b].position.set(this.ar[c+1],this.ar[c+2],this.ar[c+
3]),"BLOB"!==a.type&&a[b].quaternion.set(this.ar[c+4],this.ar[c+5],this.ar[c+6],this.ar[c+7]));a=this.root.cars;for(var b=a.length,d,e,f;b--;)if(c=40*b,this.dr[c])for(this.root.speeds[b]=this.dr[c],a[b].position.set(this.dr[c+5],this.dr[c+6],this.dr[c+7]),a[b].quaternion.set(this.dr[c+1],this.dr[c+2],this.dr[c+3],this.dr[c+4]),this.root.nav.move(a[b].position),f=4;f--;)e=8*(f+1),d=this.root.wheels[f],d.position.set(this.dr[c+e+5],this.dr[c+e+6],this.dr[c+e+7]),d.quaternion.set(this.dr[c+e+1],this.dr[c+
e+2],this.dr[c+e+3],this.dr[c+e+4]);this.computeTime()}},postAmmo:function(){this.w.postMessage({m:"run",m2:this.msg,key:this.root.nav.key,ar:this.ar,dr:this.dr},[this.ar.buffer,this.dr.buffer])},upOimo:function(a){if(a.data.init)this.postMess();else{a.data.w&&!this.isReady&&(this.isReady=!0);this.fps=a.data.fps;this.ar=a.data.ar;a=this.root.meshs;for(var b=a.length,c;b--;)c=8*b,this.ar[c]&&(a[b].position.set(this.ar[c+1],this.ar[c+2],this.ar[c+3]),"BLOB"!==a.type&&a[b].quaternion.set(this.ar[c+4],
this.ar[c+5],this.ar[c+6],this.ar[c+7]));this.computeTime()}},postOimo:function(){this.w.postMessage({m:"run",m2:this.msg,drn:this.drn,drc:this.drc,ar:this.ar,dr:this.dr},[this.ar.buffer])},room:function(a){var b=0.5*a.h-a.m;this.w.postMessage({m:"room",obj:{n:5,size:[a.w-a.m,a.m,a.d-a.m,a.w+a.m,a.h,a.m,a.w+a.m,a.h,a.m,a.m,a.h,a.d-a.m,a.m,a.h,a.d-a.m],pos:[0,0.5*-a.m,0,0,b,0.5*-a.d,0,b,0.5*a.d,0.5*-a.w,b,0,0.5*a.w,b,0]}});v.addSolid({type:"box",size:[a.w-a.m,a.h-a.m,a.d-a.m],pos:[0,b+0.5*a.m,0]});
v.addSolid({type:"box",size:[a.w+a.m,a.h,a.d+a.m],pos:[0,b,0]})},add:function(a){this.w.postMessage({m:"add",obj:a})},addParticle:function(a){this.w.postMessage({m:"addParticle",obj:a})},post:function(a){this.w.postMessage(a)},chaine:function(a){a.close&&(this.drc[0]=1);for(var b=0.5*a.points.length,c=this.drn[0]=b;c--;)b=2*c,this.dr[b]=a.points[b],this.dr[b+1]=a.points[b+1];this.updateDecal()},updateDecal:function(){this.post({m:"updecal",dr:this.dr,drn:this.drn,drc:this.drc})}};
