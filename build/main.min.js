...
this.previewTheme()},previewTheme:function(){this.previewDoc.body&&(this.previewDoc.body.className=this.mainClass);this.previewMain&&this.previewMain.v&&(this.day?this.previewMain.v.colorBack(13815496):this.previewMain.v.colorBack(2435374))},previewClearFocus:function(){for(var a=this.previewDoc.getElementsByTagName("*"),b=0,c;c=a[b++];)c.id&&c.blur()},clearPreview:function(){null!==this.preview&&(this.doc.body.removeChild(this.preview),this.previewMain=this.previewDoc=this.preview=null,console.clear())},
