...
this.boneSize,this.distances[d])))},testBvhType:function(a){"rButtock"===a&&(this.type="cgspeedDAZ",this.searchType=!1);"ToSpine"===a&&(this.type="openMotion",this.searchType=!1);"RHipJoint"===a&&(this.type="cgspeed3DS",this.searchType=!1)},transposeName:function(a){if("hip"===a||"SpineBase"===a)a="Hips";if("abdomen"===a||"SpineBase2"===a)a="Spine1";if("chest"===a||"SpineMid"===a)a="Chest";if("neck"===a||"Neck2"===a)a="Neck";"head"===a&&(a="Head");if("rCollar"===a||"rcollar"===a||"CollarRight"===
a)a="RightCollar";if("lCollar"===a||"lcollar"===a||"CollarLeft"===a)a="LeftCollar";"upperback"===a&&(a="Spine1");"lowerback"===a&&(a="Spine1");"Chest2"===a&&(a="Chest");if("rThigh"===a||"RightHip"===a||"HipRight"===a)a="RightUpLeg";if("lThigh"===a||"LeftHip"===a||"HipLeft"===a)a="LeftUpLeg";if("rShin"===a||"RightKnee"===a||"KneeRight"===a)a="RightLowLeg";if("lShin"===a||"LeftKnee"===a||"KneeLeft"===a)a="LeftLowLeg";if("rFoot"===a||"RightAnkle"===a||"AnkleRight"===a)a="RightFoot";if("lFoot"===a||"LeftAnkle"===
a||"AnkleLeft"===a)a="LeftFoot";"RightLeg"===a&&(a="RightLowLeg");"LeftLeg"===a&&(a="LeftLowLeg");if("rtoes"===a||"RightToeBase"===a)a="RightToe";if("ltoes"===a||"LeftToeBase"===a)a="LeftToe";if("rShldr"===a||"RightArm"===a||"ShoulderRight"===a)a="RightUpArm";if("lShldr"===a||"LeftArm"===a||"ShoulderLeft"===a)a="LeftUpArm";if("rForeArm"===a||"RightForeArm"===a||"RightElbow"===a||"ElbowRight"===a)a="RightLowArm";if("lForeArm"===a||"LeftForeArm"===a||"LeftElbow"===a||"ElBowLeft"===a)a="LeftLowArm";
if("rHand"===a||"RightWrist"===a||"WristRight"===a)a="RightHand";if("lHand"===a||"LeftWrist"===a||"WristLeft"===a)a="LeftHand";"RightShoulder"===a&&(a="RightCollar");"LeftShoulder"===a&&(a="LeftCollar");return a},parseNode:function(a){var b,c,d;b=a.shift();this.searchType&&this.testBvhType(b);b=this.transposeName(b);d=new THREE.Group;d.name=b;for(b=!1;!b;)switch(a.shift()){case "OFFSET":d.position.set(parseFloat(a.shift()),parseFloat(a.shift()),parseFloat(a.shift()));d.offset=d.position.clone();break;
case "CHANNELS":c=parseInt(a.shift());for(var e=0;0<=c?e<c:e>c;0<=c?e++:e--)this.channels.push({node:d,prop:a.shift()});break;case "JOINT":case "End":d.add(this.parseNode(a));break;case "}":b=!0}this.nodes.push(d);return d},clearNode:function(){var a;if(this.nodes){for(a=0;a<this.nodes.length;a++)this.nodes[a]=null;this.nodes.length=0}},animate:function(){for(var a,b=this.frame%this.numFrames*this.channels.length,c=this.channels,d=!1,e=!1,f=0,g=c.length;f<g;f++){a=c[f];d="Hips"===a.node.name?!0:!1;
e="cgspeedDAZ"===this.type&&"LeftLowArm"===a.node.name?!0:!1;switch(a.prop){case "Xrotation":this.autoDetectRotation(a.node,"X",parseFloat(this.data[b]));break;case "Yrotation":e?this.autoDetectRotation(a.node,"Y",-parseFloat(this.data[b])):this.autoDetectRotation(a.node,"Y",parseFloat(this.data[b]));break;case "Zrotation":e?this.autoDetectRotation(a.node,"Z",-parseFloat(this.data[b])):this.autoDetectRotation(a.node,"Z",parseFloat(this.data[b]));break;case "Xposition":a.node.position.x=d?a.node.offset.x+
parseFloat(this.data[b])+this.position.x:a.node.offset.x+parseFloat(this.data[b]);break;case "Yposition":a.node.position.y=d?a.node.offset.y+parseFloat(this.data[b])+this.position.y:a.node.offset.y+parseFloat(this.data[b]);break;case "Zposition":a.node.position.z=d?a.node.offset.z+parseFloat(this.data[b])+this.position.z:a.node.offset.z+parseFloat(this.data[b])}b++}0<this.bones.length&&this.updateSkeleton()},autoDetectRotation:function(a,b,c){this.tmpOrder+=b;c*=V.ToRad;"X"===b?this.tmpAngle[0]=c:
"Y"===b?this.tmpAngle[1]=c:this.tmpAngle[2]=c;3===this.tmpOrder.length&&(b=new THREE.Euler(this.tmpAngle[0],this.tmpAngle[1],this.tmpAngle[2],this.tmpOrder),this.order[a.name]=this.tmpOrder,a.setRotationFromEuler(b),a.updateMatrixWorld(),this.tmpOrder="",this.tmpAngle.length=0)},update:function(){this.play&&(this.frame=(Date.now()-this.startTime)/this.secsPerFrame/1E3*this.speed|0,0!==this.oldFrame&&(this.frame+=this.oldFrame),this.frame>this.numFrames&&(this.oldFrame=this.frame=0,this.startTime=
Date.now()),this.animate())},next:function(){this.play=!1;this.frame++;this.frame>this.numFrames&&(this.frame=0);this.animate()},prev:function(){this.play=!1;this.frame--;0>this.frame&&(this.frame=this.numFrames);this.animate()}};V.DistanceTest=function(a,b){var c=b.x-a.x,d=b.y-a.y,e=b.z-a.z,c=Math.sqrt(c*c+d*d+e*e);0>=c&&(c=0.1);return c};
