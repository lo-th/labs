...
v.basic=new THREE.Mesh(V.TransGeo(b,!0),v.tmpmat);"skull"==v.model?v.basic.scale.set(10,10,-10):"skullhigh"==v.model?v.basic.scale.set(2,2,-2):"head"==v.model?(v.basic.scale.set(8,8,-8),v.basic.position.y=-40):"woman"==v.model?(v.basic.scale.set(60,60,-60),v.basic.position.y=-37):v.basic.scale.set(1,1,-1);v.scene.add(v.basic)},basic:function(){this.basic=new THREE.Mesh(this.geo.ground,this.mat.base);this.basic.scale.set(50,50,50);this.scene.add(this.basic)},ground:function(){this.m=new THREE.Mesh(this.geo.ground,
this.mat.base);this.m.scale.set(50,50,50);this.scene.add(this.m)},tell:function(a){this.info.innerHTML=a},addBlob:function(a,b,c){a=new V.Blob(this,a,b);if(c)return a;this.meshs[this.meshs.length]=a},addSolid:function(a){var b=new THREE.Mesh(this.geo[a.type||"box"],this.mat.base);a.pos=a.pos||[0,0,0];a.size=a.size||[1,1,1];b.scale.set(a.size[0],a.size[1],a.size[2]);b.position.set(a.pos[0],a.pos[1],a.pos[2]);b.rotation.set(0,0,0);this.scene.add(b);b.visible=!1;b=new THREE.BoxHelper(b);b.material=this.mat[a.mat||
"chaine"];this.scene.add(b)},add:function(a){var b;a.pos=a.pos||[0,0,0];a.size=a.size||[1,1,1];"blob"==a.type?(b=new THREE.Vector3(a.pos[0],a.pos[1],a.pos[2]),b=new V.Blob(this,b,4*a.size[0]),this.sceneBlob.add(b)):(b=new THREE.Mesh(this.geo[a.type||"box"],this.mat[a.mat||"base2"]),b.scale.set(a.size[0],a.size[1],a.size[2]),b.position.set(a.pos[0],a.pos[1],a.pos[2]),b.rotation.set(0,0,0),this.scene.add(b));this.meshs[this.meshs.length]=b;this.w&&this.w.add(a)},addParticle:function(a){var b=this.ps.length;
this.ps[b]=new V.Particle(this,a);a.id=b;this.w&&this.w.addParticle(a)},initGeo:function(){var a={};a.sphere=(new THREE.BufferGeometry).fromGeometry(new THREE.SphereGeometry(1,12,10));a.sphereHigh=(new THREE.BufferGeometry).fromGeometry(new THREE.SphereGeometry(1,34,28));a.box=(new THREE.BufferGeometry).fromGeometry(new THREE.BoxGeometry(1,1,1));a.cylinder=(new THREE.BufferGeometry).fromGeometry(new THREE.CylinderGeometry(1,1,1,12,1));a.plane=new THREE.PlaneBufferGeometry(1,1);a.ground=new THREE.PlaneBufferGeometry(1,
1);a.ground.applyMatrix((new THREE.Matrix4).makeRotationX(-V.PI90));this.geo=a},initMat:function(){var a={};a.none=new THREE.MeshBasicMaterial({transparent:!0,opacity:0,fog:!1,depthTest:!1,depthWrite:!1});a.zone=new THREE.MeshBasicMaterial({color:65280,transparent:!0,opacity:0.1,fog:!1,depthTest:!1,depthWrite:!1});a.base=new THREE.MeshBasicMaterial({color:0});a.anchor=new THREE.MeshBasicMaterial({color:16711795});a.chaine=new THREE.LineBasicMaterial({color:16711795,transparent:!0,opacity:0.3});a.Sanchor=
new THREE.MeshBasicMaterial({color:16777215});a.base2=new THREE.MeshBasicMaterial({color:65280,map:THREE.ImageUtils.loadTexture("images/grid1.jpg")});a.solid=new THREE.MeshBasicMaterial({color:16711795,transparent:!0,opacity:0.05,depthWrite:!1});this.mat=a},addWorker:function(a,b){this.w=new V.Worker(this,a);this.wFun=b||function(){}},addRenderTarget:function(a,b){var c=new THREE.WebGLRenderTarget(a,b,{minFilter:THREE.LinearFilter,magFilter:THREE.LinearFilter,format:THREE.RGBAFormat});this.isWithSerious=
!0;return c},chaine:function(a){for(var b=a.close||!1,c=this.lines.length,d=new THREE.Geometry,e=0.5*a.points.length,f,g=0;g<e;g++)f=2*g,f=new THREE.Vector3(a.points[f],0,a.points[f+1]),d.vertices.push(f),this.addAnchor(f,c,g,b);a.close&&d.vertices.push(new THREE.Vector3(a.points[0],0,a.points[1]));b=new THREE.Line(d,this.mat.chaine);this.scene.add(b);this.lines[c]=b;this.w&&this.w.chaine(a)},addAnchor:function(a,b,c,d){var e=new THREE.Mesh(this.geo.sphere,this.mat.anchor);e.scale.set(0.5,0.5,0.5);
