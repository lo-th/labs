...
this.doc.body.appendChild(this.preview);this.preview.className="preview";this.resize();this.previewDoc=this.preview.contentDocument||this.preview.contentWindow.document;var a="<script src='./src/Vue3d.js'>\x3c/script>",b="<script src='./js/libs/three.js'>\x3c/script>";isMain&&(a="<script src='./build/v3d.min.js'>\x3c/script>",b="<script src='./js/libs/three.min.js'>\x3c/script>");for(var c="",d=LTH.option[LTH.cRubrique][LTH.cFile],e=d.length;e--;)c+="<script src='./js/libs/"+d[e]+".min.js'>\x3c/script>";
a=["<!DOCTYPE html>\n<html lang='en'>\n<head>\n<title>prev</title>\n<meta charset='utf-8'>\n<link rel='stylesheet' href='./css/consolas.css'>\n<link rel='stylesheet' href='./css/basic.css'>",b,"<script src='./js/libs/three.post.js'>\x3c/script>",c,a,"<script id='shader'>\x3c/script>\n</head><body>\n<script> var main = null; var canvas = document.createElement('canvas'); document.body.appendChild( canvas );\x3c/script>\n</body></html>"].join("\n");this.preview.src="about:blank";this.previewDoc=this.preview.contentDocument||
this.preview.contentWindow.document;this.previewDoc.open("text/html","replace");this.previewDoc.write(a);this.previewDoc.close()},update:function(a){if(""!==a){this.clearPreview();this.initPreview();var b=this;this.preview.onload=function(c){b.previewTheme();b.previewMain=b.preview.contentWindow;"shader"===b.mode&&(b.previewMain.main=b);c=b.previewDoc.getElementsByTagName("head")[0];b.preview.style.display="block";var d=b.previewDoc.createElement("script");d.setAttribute("id","base");d.type="text/javascript";
d.charset="utf-8";d.text=a;c.appendChild(d);b.codeLoaded=!0;b.previewTheme();b.isFirst?b.isFirst=!1:b.showModif()}}},checkCurrent:function(){for(var a=0;a<this.numLesson;a++)this.items[a].style.background=this.items[a].name==this.currentLesson?"#881288":"#121212"},loadFile:function(a){this.isFirst=!0;this.fileSystem.load(a)},openFile:function(a){this.fileSystem.open(a)},createLink:function(a,b,c){this.menu.addIconLink(a,b,c)},showModif:function(){this.menu.modified()},callSave:function(){this.fileSystem.save()}};
