...
this.z=null;this.zones=[];this.scene=new THREE.Scene;this.sceneBlob=new THREE.Scene;this.nav=new V.Nav(this,a,b,c);this.base=new THREE.Group;this.content=new THREE.Group;this.skinned=new THREE.Group;this.scene.add(this.base);this.scene.add(this.content);this.scene.add(this.skinned);this.environment=null;this.initGeo();this.initMat();this.pool=new V.SeaPool(this);this.impool=new V.ImgPool(this);d&&this.loadBasic();this.postEffect=null;this.deb="";this.f=[0,0,0,0];this.meshs=[];this.cars=[];this.speeds=
[];this.wheels=[];this.steering=[];this.lines=[];this.anchors={};this.ps=[];this.model="skull";this.w=this.basic=null;this.isWithSerious=this.isW=!1;window.onresize=function(a){this.resize(a)}.bind(this)};
...
1);b.ground.applyMatrix((new THREE.Matrix4).makeRotationX(-V.PI90));this.geo=b},initMat:function(){this.environment=THREE.ImageUtils.loadTexture("images/spherical/e_chrome.jpg");this.environment.mapping=THREE.SphericalReflectionMapping;var a={};a.none=new THREE.MeshBasicMaterial({transparent:!0,opacity:0,fog:!1,depthTest:!1,depthWrite:!1});a.zone=new THREE.MeshBasicMaterial({color:65280,transparent:!0,opacity:0.1,fog:!1,depthTest:!1,depthWrite:!1});a.base=new THREE.MeshBasicMaterial({color:0});a.anchor=
new THREE.MeshBasicMaterial({color:16711795});a.chaine=new THREE.LineBasicMaterial({color:16711795,transparent:!0,opacity:0.3});a.Sanchor=new THREE.MeshBasicMaterial({color:16777215});a.base2=new THREE.MeshBasicMaterial({color:65280,map:THREE.ImageUtils.loadTexture("images/grid1.jpg")});a.solid=new THREE.MeshBasicMaterial({color:16711795,transparent:!0,opacity:0.05,depthWrite:!1});a.shad_box=new THREE.MeshBasicMaterial({color:15158332,envMap:this.environment,reflectivity:0.4});a.shad_sphere=new THREE.MeshBasicMaterial({color:2719929,
envMap:this.environment,reflectivity:0.4});a.shad_cylinder=new THREE.MeshBasicMaterial({color:9323693,envMap:this.environment,reflectivity:0.4});this.mat=a},addWorker:function(a,b){this.w=new V.Worker(this,a);this.wFun=b||function(){}},addRenderTarget:function(a,b){var c=new THREE.WebGLRenderTarget(a,b,{minFilter:THREE.LinearFilter,magFilter:THREE.LinearFilter,format:THREE.RGBAFormat});this.isWithSerious=!0;return c},chaine:function(a){for(var b=a.close||!1,c=this.lines.length,d=new THREE.Geometry,
e=0.5*a.points.length,f,g=0;g<e;g++)f=2*g,f=new THREE.Vector3(a.points[f],0,a.points[f+1]),d.vertices.push(f),this.addAnchor(f,c,g,b);a.close&&d.vertices.push(new THREE.Vector3(a.points[0],0,a.points[1]));b=new THREE.Line(d,this.mat.chaine);this.scene.add(b);this.lines[c]=b;this.w&&this.w.chaine(a)},addAnchor:function(a,b,c,d){var e=new THREE.Mesh(this.geo.sphere,this.mat.anchor);e.scale.set(0.5,0.5,0.5);e.position.copy(a);e.name=d?"ca"+b+"_"+c:"oa"+b+"_"+c;this.base.add(e);this.anchors[e.name]=e},
upAnchor:function(a){var b=a.name,c=b.lastIndexOf("_"),d=b.substring(2,c)||0,d=1*d,c=b.substring(c+1,b.length)||0,c=1*c,d=this.lines[d],e=d.geometry.vertices.length;d.geometry.vertices[c].copy(a.position);"c"==b.substring(0,1)&&0==c&&d.geometry.vertices[e-1].copy(a.position);d.geometry.verticesNeedUpdate=!0;this.w&&(this.w.dr[2*c]=a.position.x,this.w.dr[2*c+1]=a.position.z,this.w.updateDecal())}};
