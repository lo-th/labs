...
a.stopPropagation()}},rayTest:function(a){this.rayVector.x=this.mouse.x/this.root.dimentions.w*2-1;this.rayVector.y=2*-(this.mouse.y/this.root.dimentions.h)+1;this.rayVector.unproject(this.camera);this.raycaster.ray.set(this.camera.position,this.rayVector.sub(this.camera.position).normalize());a=this.raycaster.intersectObjects(this.root.base.children);0<a.length?(this.selectName=a[0].object.name,this.mouse3d.copy(a[0].point),"function"==typeof mainRay&&mainRay(this.mouse3d,this.selectName)):this.selectName=
""},bindKeys:function(){window.top.onkeydown=function(a){a=a||window.event;switch(a.keyCode){case 38:case 87:case 90:this.key.up=1;break;case 40:case 83:this.key.down=1;break;case 37:case 65:case 81:this.key.left=1;break;case 39:case 68:this.key.right=1;break;case 17:case 67:this.key.ctrl=1;break;case 69:this.key.action=1;break;case 32:this.key.space=1;break;case 16:this.key.shift=1}}.bind(this);window.top.onkeyup=function(a){a=a||window.event;switch(a.keyCode){case 38:case 87:case 90:this.key.up=
0;break;case 40:case 83:this.key.down=0;break;case 37:case 65:case 81:this.key.left=0;break;case 39:case 68:this.key.right=0;break;case 17:case 67:this.key.ctrl=0;break;case 69:this.key.action=0;break;case 32:this.key.space=0;break;case 16:this.key.shift=0}}.bind(this)},unwrapDegrees:function(a){a%=360;180<a&&(a-=360);-180>a&&(a+=360);return a},unwrapRadian:function(a){a%=V.TwoPI;a>Math.PI&&(a-=V.TwoPI);a<-Math.PI&&(a+=V.TwoPI);return a}};
