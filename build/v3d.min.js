...
0);this.renderer.autoClear=!1;this.clock=new THREE.Clock;this.delta=0;this.z=null;this.zones=[];this.scene=new THREE.Scene;this.sceneBlob=new THREE.Scene;this.nav=new V.Nav(this,a,b,c);this.base=new THREE.Group;this.content=new THREE.Group;this.skinned=new THREE.Group;this.scene.add(this.base);this.scene.add(this.content);this.scene.add(this.skinned);this.environment=null;this.initGeo();this.initMat();this.pool=new V.SeaPool(this);this.impool=new V.ImgPool(this);d&&this.loadBasic();this.postEffect=
null;this.deb="";this.f=[0,0,0,0];this.meshs=[];this.cars=[];this.speeds=[];this.wheels=[];this.steering=[];this.lines=[];this.anchors={};this.ps=[];this.model="skull";this.w=this.groundMirror=this.basic=null;this.isWithSerious=this.isW=!1;window.onresize=function(a){this.resize(a)}.bind(this)};
...
vs:"varying vec3 vWorldPosition;\nvoid main(){\n    vWorldPosition = vec4(modelMatrix * vec4( position, 1.0 )).xyz;\n    gl_Position = projectionMatrix * modelViewMatrix * vec4(position,1.0);\n}"};V.Worker=function(a,b){this.root=a;this.name=b;this.msg="";this.postMess=this.update=null;this.testNewAmmo=window.top.main.useDirectDebug;var c,d,e,f,g,l,h,k;switch(this.name){case "crowd":c="js/worker/crowd_worker.js";k="../../js/libs/crowd.js";d=1E3;e=100;f=10;g=1E3;l=3;h=2;this.update=this.upCrowd;this.postMess=this.postCrowd;break;case "liquid":c="js/worker/liquid_worker.js";k="../../js/libs/liquidfun.js";d=1E3;e=100;f=10;g=8E3;l=4;h=2;this.update=this.upLiquid;this.postMess=this.postLiquid;break;
case "oimo":c="js/worker/oimo_worker.js";k="../../js/libs/oimo.min.js";d=1E3;f=e=10;g=0;l=8;h=3;this.update=this.upOimo;this.postMess=this.postOimo;break;case "ammo":c=this.testNewAmmo?"js/worker/ammo_worker_new.js":"js/worker/ammo_worker.js";k="../../js/libs/ammo.min.js";d=1E3;e=20;f=10;g=0;l=8;h=40;this.update=this.upAmmo;this.postMess=this.postAmmo;break;case "traffic":c="js/worker/traffic_worker.js",k="../../js/libs/traffic.min.js",d=1E3,f=e=10,g=0,h=l=3,this.update=this.upTraffic,this.postMess=
this.postTraffic}window.top.main.transcode.useTrans&&(k=window.top.main.transcode.codes[this.name]);this.w=new Worker(c);this.w.postMessage=this.w.webkitPostMessage||this.w.postMessage;this.w.onmessage=function(a){this.update(a)}.bind(this);this.ar=new V.AR32(d*l);this.dr=new V.AR32(e*h);this.pr=new V.AR32(g*h);this.drn=new V.AR32(f);this.drc=new V.AR32(f);this.prn=new V.AR32(f);this.d=[16.667,0,0];this.isReady=!1;this.fps=0;this.w.postMessage({m:"init",url:k})};
...
time:this.d[1],m2:this.msg,key:this.root.nav.key,ar:this.ar,dr:this.dr},[this.ar.buffer,this.dr.buffer])},upOimo:function(a){if(a.data.init)this.postMess();else{a.data.w&&!this.isReady&&(this.isReady=!0);this.fps=a.data.fps;this.ar=a.data.ar;a=this.root.meshs;for(var b=a.length,c;b--;)c=8*b,this.ar[c]&&(a[b].position.set(this.ar[c+1],this.ar[c+2],this.ar[c+3]),"BLOB"!==a.type&&a[b].quaternion.set(this.ar[c+4],this.ar[c+5],this.ar[c+6],this.ar[c+7]));this.computeTime()}},postOimo:function(){this.w.postMessage({m:"run",
