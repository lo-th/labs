...
V.Shader.prototype.upColor=function(a,b){this.uniforms[a]&&this.uniforms[a].value.setRGB(b[0]/255,b[1]/255,b[2]/255)};V.Shader.prototype.upBool=function(a,b){this.uniforms[a]&&(this.uniforms[a].value=b?1:0)};V.Shader.prototype.init=function(a){this.setValues(a)};
V.Shader.prototype.apply=function(a){this.uniforms=THREE.UniformsUtils.clone(a.uniforms);this.vertexShader=a.vs;this.fragmentShader=a.fs;for(var b in this.parameters)this.uniforms[b]&&(this.uniforms[b].value=this.parameters[b]);this.visible=this.isActive=!0};
V.Shader.prototype.loading=function(a){var b;window.XMLHttpRequest?b=new XMLHttpRequest:window.ActiveXObject&&(b=new ActiveXObject("Microsoft.XMLHTTP"));b.onload=function(a){a=eval(b.responseText);this.uniforms=a.uniforms;this.vertexShader=a.vs;this.fragmentShader=a.fs;for(var d in this.parameters)this.uniforms[d]&&(this.uniforms[d].value=this.parameters[d],console.log(d));this.callback();this.visible=this.isActive=!0}.bind(this);b.open("GET","shaders/"+a+".js",!0);b.send()};V.Worker=function(a,b){this.name=b;this.root=a;this.msg="";var c,d,e,g,f,h,k;switch(this.name){case "liquid":c="./js/worker/liquid_worker.js";d=1E3;e=100;g=10;f=1E3;h=4;k=2;break;case "oimo":c="./js/worker/oimo_worker.js",d=1E3,g=e=10,f=0,h=8,k=3}this.ar=new V.AR32(d*h);this.dr=new V.AR32(e*k);this.pr=new V.AR32(f*k);this.drn=new V.AR8(g);this.drc=new V.AR8(g);this.prn=new V.AR8(g);this.w=new Worker(c);this.w.postMessage=this.w.webkitPostMessage||this.w.postMessage;this.d=[16.667,0,0];this.isReady=
