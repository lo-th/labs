'use strict';var LTH={CODES:"full serious rot liquidfun ammo oimo crowd".split(" "),rubriques:[],demoNames:[],libsNames:[],cRubr:-1,cFile:0},esprima=esprima||{};esprima.parse=esprima.parse||{};var CodeMirror=CodeMirror||{},GRAD=GRAD||{},history,main;window.onload=init;function init(){main=new LTH.Main}function endTranscode(){main.menu.initHomeland(main.transcode.isWebGl)}
...
update:function(a){if(""!==a){this.clearPreview();this.initPreview();var b,c,d;if(this.transcode.useTrans){b="";c=LTH.libsNames[LTH.cRubr][LTH.cFile];for(d=c.length;d--;)""!==c[d]&&(b+="<script src='js/libs/"+c[d]+".min.js'>\x3c/script>");a=["<!DOCTYPE html>\n<html lang='en'><head>\n<title>prev</title>\n<meta charset='utf-8'>\n<link rel='stylesheet' href='css/consolas.css'>\n<link rel='stylesheet' href='css/basic.css'>","<script src='"+this.transcode.codes.full+"'>\x3c/script>",b,"<script src='build/v3d.min.js'>\x3c/script>",
