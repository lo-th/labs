...
this.codeLoaded&&this.previewTheme()},previewTheme:function(){this.previewDoc.body.className=this.day?"day":"night";this.previewMain&&(this.day?this.previewMain.v.colorBack(13815496):this.previewMain.v.colorBack(2435374))},previewClearFocus:function(){for(var a=this.previewDoc.getElementsByTagName("*"),b=0,c;c=a[b++];)c.id&&c.blur()},clearPreview:function(){null!==this.preview&&(this.doc.body.removeChild(this.preview),this.preview=null)},initPreview:function(){this.preview=this.doc.createElement("iframe");
this.preview.className="preview";this.preview.style.cssText="position:absolute;  border:none; pointer-events:auto; background:none; z-index:0; display:none;";this.doc.body.appendChild(this.preview)},update:function(a){if(""!==a){this.codeLoaded=!1;this.clearPreview();this.initPreview();this.tmpcode=a;a="<script src='./src/Vue3d.js'>\x3c/script>";var b="<script src='./js/libs/three.js'>\x3c/script>";isMain&&(a="<script src='./build/v3d.min.js'>\x3c/script>",b="<script src='./js/libs/three.min.js'>\x3c/script>");
for(var c="",d=LTH.option[LTH.cRubrique][LTH.cFile],f=d.length;f--;)c+="<script src='./js/libs/"+d[f]+".min.js'>\x3c/script>";a=["<!DOCTYPE html>\n<html lang='en'>\n<head>\n<title>prev</title>\n<meta charset='utf-8'>\n<link rel='stylesheet' href='./css/consolas.css'>\n<link rel='stylesheet' href='./css/basic.css'>",b,"<script src='./js/libs/three.post.js'>\x3c/script>",c,a,"<script id='shader'>\x3c/script>\n</head><body>\n<script> var main = null; var canvas = document.createElement('canvas'); document.body.appendChild( canvas ); \x3c/script>\n</body></html>"].join("\n");
this.preview.src="about:blank";try{this.previewDoc=this.preview.contentDocument||this.preview.contentWindow.document,this.previewMain=this.preview.contentWindow}catch(g){}finally{this.previewDoc.open("text/html","replace");this.previewDoc.write(a);this.previewDoc.close(this.preview);var e=this;this.previewMain.onload=function(a){e.frameLoaded()}}}},frameLoaded:function(){console.log("loaded");"shader"===this.mode&&(this.previewMain.main=this);var a=this.previewDoc.getElementsByTagName("head")[0],
b=this.previewDoc.createElement("script");b.type="text/javascript";b.charset="utf-8";b.text=this.tmpcode;a.appendChild(b);this.tmpcode="";this.preview.style.display="block";this.codeLoaded=!0;this.previewTheme();this.resize();this.isFirst?this.isFirst=!1:this.showModif()},checkCurrent:function(){for(var a=0;a<this.numLesson;a++)this.items[a].style.background=this.items[a].name==this.currentLesson?"#881288":"#121212"},loadFile:function(a){this.isFirst=!0;this.fileSystem.load(a)},openFile:function(a){this.fileSystem.open(a)},
createLink:function(a,b,c){this.menu.addIconLink(a,b,c)},showModif:function(){this.menu.modified()},callSave:function(){this.fileSystem.save()}};LTH.ShaderToy=function(a){this.main=a;this.retour=document.createElement("div");this.retour.innerHTML=".join('&#92;n')";this.shaderName="";this.shaderBase=null;this.uniformValues={};this.uniformColors={};this.isShaderReady=!1};
...
g=null,e;for(e in this.uniformValues)e===b&&(g=JSON.parse(this.uniformValues[e]));for(e in this.uniformColors)e===b&&(g=JSON.parse(this.uniformColors[e]),d=!0);e="";switch(a){case "sampler2D":case "samplerCube":e="t";break;case "vec2":e="v2";null!==g&&(f="new THREE.Vector2("+g.x+","+g.y+")");break;case "vec3":d?(e="c",null!==g&&(f="new THREE.Color("+g.r+","+g.g+","+g.b+")")):(e="v3",null!==g&&(f="new THREE.Vector3("+g.x+","+g.y+","+g.z+")"));break;case "vec4":e="v4";null!==g&&(f="new THREE.Vector3("+
g.x+","+g.y+","+g.z+","+g.w+")");break;case "int":e="i";null!==g&&(f=g);break;case "float":e="f";null!==g&&(f=g);break;case "mat4":e="m4"}c||(e+="v");this.uniform+=b+" : { type: '"+e+"', value: "+f+" },\n"},isAlphanumeric:function(a){return/^[0-9a-zA-Z]+$/.test(a)},getShader:function(a){for(var b="",c=a.lineCount(),d,f=0;f<c;f++)d=a.getLine(f),void 0!==d&&("uniform"===d.substring(0,7)&&this.pushUniform(d),b=0==f?b+("\n'"+d+"',\n"):f==c-1?b+("'"+d+"'\n"):b+("'"+d+"',\n"));return b}};
...
addFile:function(a){var b=this,c=new FileReader;c.onload=function(c){c=a.name;c.substr(c.lastIndexOf(".")+1,c.length);b.pushFile(c)};c.readAsDataURL(a)},pushFile:function(a){for(var b=this,c=this.files.length;c--;)if(a==this.files[c])return;var c=this.icons.length,d=document.createElement("div");d.className="ic";var f=document.createElement("div");f.style.cssText="position:relative; left:10px; top:5px; width:18px; height:18px; pointer-events:none; background-color: none; border:2px solid rgba(0,0,0,0);  border-radius:20px;";
var g=document.createElement("div");g.style.cssText="position:relative; left:30px; top:-12px; width:calc(100% - 40px); height:20px; pointer-events:none; text-align:right;";var e=document.createElement("div");e.style.cssText="position:relative; left:15px; top:-28px; width:8px; height:8px; pointer-events:none; background-color: "+this.colorSelect+";  border-radius:20px;";g.innerHTML=a.substr(0,a.lastIndexOf("."));d.appendChild(f);d.appendChild(g);d.appendChild(e);this.zone.appendChild(d);d.name=c;d.onclick=
...
{tolerant:!0}).errors,d=0;d<f.length;d++){var g=f[d],e=document.createElement("div");e.className="esprima-error";e.textContent=g.message.replace(/Line [0-9]+: /,"");var h=g.lineNumber-1;c.errorLines.push(h);b.addLineClass(h,"background","errorLine");var k=b.addLineWidget(h,e);c.widgets.push(k)}}catch(l){e=document.createElement("div"),e.className="esprima-error",e.textContent=l.message.replace(/Line [0-9]+: /,""),h=l.lineNumber-1,c.errorLines.push(h),b.addLineClass(h,"background","errorLine"),k=b.addLineWidget(h,
e),c.widgets.push(k)}return 0===c.errorLines.length})}};LTH.FileSystem=function(a){this.main=a};
LTH.FileSystem.prototype={constructor:LTH.FileSystem,load:function(a,b){a.substring(a.lastIndexOf(".")+1,a.length);var c=a.substring(a.lastIndexOf("/")+1,a.lastIndexOf(".")),d;window.XMLHttpRequest?d=new XMLHttpRequest:window.ActiveXObject&&(d=new ActiveXObject("Microsoft.XMLHTTP"));d.open("GET","./"+a,!0);d.responseType="blob";var f=this;d.onload=function(a){a=new FileReader;a.onload=function(a){f.process(c,a.target.result,b)};a.readAsText(this.response)};d.send()},open:function(a,b){var c=a.name,
