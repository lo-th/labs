...
LTH.Menu=function(a){this.baseColor="d2cec8";this.main=a;this.doc=document;this.content=this.doc.createElement("div");this.content.className="menu";this.doc.body.appendChild(this.content);this.rubriques=[];this.icons=[];this.files=[];this.buttons=[];this.inModif=this.currentFile=-1;this.colorSelect="#d2cec8";this.colorModif="#FF0073";this.colorOver="rgba(255,255,255,0.3)";this.logo=this.zone=this.currentLink=null;this.isHome=this.isMenu=!1;this.leftMenu=this.home=null;this.initLogo();this.initHome();
