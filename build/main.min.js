'use strict';var LTH={rubriques:[],demoNames:[],libsNames:[],cRubr:-1,cFile:0},esprima=esprima||{};esprima.parse=esprima.parse||{};var CodeMirror=CodeMirror||{},GRAD=GRAD||{},history,main;window.onload=init;function init(){main=new LTH.Main}
LTH.Main=function(){this.menuSize=60;this.doc=document;this.mainClass=this.doc.body.className="night";this.doc.body.ondragover=function(a){return!1};this.day=!1;this.mode="basic";this.startDemo=0;this.numLesson=4;this.items=[];this.showCode=!1;this.viewType="vertical";this.scriptText=14;this.currentLesson=-1;this.isFirst=!1;this.previewMain=this.previewDoc=this.preview=this.editorFragment=this.editorVertex=this.editor=this.menu=null;this.happ=this.supports_history_api();this.fileSystem=new LTH.FileSystem(this);
...
this.logo.innerHTML=LTH.Logos(this.baseColor)},blinkOpen:function(a){a.logo.innerHTML=LTH.Logos(a.baseColor,!1);LTH.logoTimer=setTimeout(a.blinkClose,3E3,a)},blinkClose:function(a){a.logo.innerHTML=LTH.Logos(a.baseColor,!0);LTH.logoTimer=setTimeout(a.blinkOpen,150,a)},initHome:function(){this.doc.body.onmousemove=function(a){return!1};this.content.className="menu home";this.blinkOpen(this);this.micrologo.style.display="block";this.main.shader.clear();this.isMenu&&this.resetMenu();if(!this.isHome){LTH.cRubr=
-1;LTH.cFile=0;this.title.innerHTML="LOTH LABS";this.home=this.doc.createElement("div");this.home.style.cssText="position:absolute; left:10%; top:160px; width:80%; height:400px; text-align:center;";this.content.appendChild(this.home);for(var a,b=0;b<LTH.rubriques.length;b++)a=this.doc.createElement("div"),a.className="rub",a.name=b,a.innerHTML=LTH.rubriques[b].toUpperCase(),a.onclick=function(a){this.resetHome(a)}.bind(this),a.onmouseover=function(a){a.target.className="rub rubover"},a.onmouseout=
function(a){a.target.className="rub"},this.home.appendChild(a);this.isHome=!0}},resetHome:function(a){this.stopBlink();this.micrologo.style.display="none";LTH.cRubr=a.target.name;this.clearDiv(this.home);this.content.removeChild(this.home);this.isHome=!1;this.initMenu();this.main.happ&&history.pushState(null,null,"index.html");a.preventDefault()},resetMenu:function(){this.main.editor.clear();"shader"===this.main.mode&&(this.main.editorVertex.clear(),this.main.editorFragment.clear());this.main.clearPreview();
this.clearDiv(this.zone);this.clearDiv(this.leftMenu);this.content.removeChild(this.leftMenu);this.content.removeChild(this.zone);this.icons=[];this.files=[];this.buttons=[];this.isMenu=!1},initMenu:function(){this.doc.body.onmousemove=function(a){this.showHideMenu(a)}.bind(this);this.content.className="menu exemple";this.logo.className="logo lmin";var a="basic";"shaders"===LTH.rubriques[LTH.cRubr]&&(a="shader");this.main.switchMode(a);this.main.resize();this.title.innerHTML="";this.initButton();
this.initZone();for(var b=LTH.demoNames[LTH.cRubr],c=b.length,d=0;d<c;d++)a=b[d]+".js",this.pushFile(a);this.currentFile=this.main.startDemo||0;this.main.loadFile("demos/"+LTH.rubriques[LTH.cRubr]+"/"+this.files[this.currentFile]);this.resetIcon();this.isMenu=!0},clearDiv:function(a){for(;a.firstChild;)a.removeChild(a.firstChild)},initZone:function(){this.zone=this.doc.createElement("div");this.zone.className="zone";this.content.appendChild(this.zone);var a=this;this.zone.ondragover=function(b){a.zoneDragOver(b)};
...
LTH.FileSystem.prototype={constructor:LTH.FileSystem,loadXML:function(a){var b;window.XMLHttpRequest?b=new XMLHttpRequest:window.ActiveXObject&&(b=new ActiveXObject("Microsoft.XMLHTTP"));b.onload=function(a){a=b.responseXML.getElementsByTagName("rubrique");for(var d,f=0;f<a.length;f++){d=a[f];LTH.rubriques[f]=d.attributes[0].value;LTH.demoNames[f]=[];LTH.libsNames[f]=[];d=d.getElementsByTagName("demo");for(var e=0;e<d.length;e++)LTH.demoNames[f][e]=d[e].attributes[0].value,LTH.libsNames[f][e]=d[e].attributes[1].value.split("|").map(function(a){return a})}this.main.init()}.bind(this);
b.open("GET",a,!0);b.send()},load:function(a){a.substring(a.lastIndexOf(".")+1,a.length);var b=a.substring(a.lastIndexOf("/")+1,a.lastIndexOf(".")),c;window.XMLHttpRequest?c=new XMLHttpRequest:window.ActiveXObject&&(c=new ActiveXObject("Microsoft.XMLHTTP"));c.onload=function(a){this.process(b,c.responseText)}.bind(this);c.open("GET",a,!0);c.send()},open:function(a){var b=a.name,c=new FileReader,d=this;c.onload=function(a){d.process(b,a.target.result)};c.readAsText(a.file)},save:function(){var a=new Blob([this.main.editor.get()],
{type:"application/text/javascript;charset=utf-8"});this.main.createLink(a,this.main.editor.currentName+".js","application/text/javascript;charset=utf-8")},process:function(a,b){this.main.editor.editor.setValue(b);this.main.editor.currentName=a}};LTH.ShaderToy=function(a){this.main=a;this.retour=document.createElement("div");this.retour.innerHTML=".join('&#92;n')";this.shaderName="";this.shaderBase=null;this.uniformValues={};this.uniformColors={};this.uniformNames={};this.isShaderReady=!1;this.interval=null};
...
a+"]"+this.retour.innerHTML,"}"].join("\n");this.main.preview.contentWindow.shader.updateShader(a)}},pushUniform:function(a){var b=a.split(String.fromCharCode(32));a=b[1];var b=b[2].replace(";",""),c=this.isAlphanumeric(b),d=!1,f=null,e=null,g;for(g in this.uniformValues)g===b&&(e=JSON.parse(this.uniformValues[g]));for(g in this.uniformColors)g===b&&(e=JSON.parse(this.uniformColors[g]),d=!0);var h="";switch(a){case "sampler2D":case "samplerCube":h="t";break;case "vec2":h="v2";null!==e&&(f="new THREE.Vector2("+
e.x+","+e.y+")");break;case "vec3":d?(h="c",null!==e&&(f="new THREE.Color("+e.r+","+e.g+","+e.b+")")):(h="v3",null!==e&&(f="new THREE.Vector3("+e.x+","+e.y+","+e.z+")"));break;case "vec4":h="v4";null!==e&&(f="new THREE.Vector3("+e.x+","+e.y+","+e.z+","+e.w+")");break;case "int":h="i";null!==e&&(f=e);break;case "float":h="f";null!==e&&(f=e);break;case "mat4":h="m4"}c||(h+="v");for(g in this.uniformNames)if(g===b)return;this.uniform+=b+" : { type: '"+h+"', value: "+f+" },\n";this.uniformNames[b]=1},
isAlphanumeric:function(a){return/^[0-9a-zA-Z]+$/.test(a)},getShader:function(a){for(var b="",c=a.lineCount(),d,f=0;f<c;f++)d=a.getLine(f),void 0!==d&&("uniform"===d.substring(0,7)&&this.pushUniform(d),b=0==f?b+("\n'"+d+"',\n"):f==c-1?b+("'"+d+"'\n"):b+("'"+d+"',\n"));return b}};LTH.CodeEditor=function(a,b){this.type=b||"base";this.main=a;this.doc=document;this.interval=this.editor=null;this.currentName=this.mode="";this.content=this.doc.createElement("div");this.content.className="editor";this.content.id="editor"+this.type;this.doc.body.appendChild(this.content);this.errorLines=[];this.widgets=[];this.isStart=this.isEnd=!1;this.init()};
